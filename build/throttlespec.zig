...
fn cat_gate(state: RiderState, _arg_seg: Segment, a_: f64) f64 {
    return (if (_arg_seg.has_cat) (if ((a_ > @as(f64, @bitCast(@as(i64, 0))))) @as(f64, (if (cat_in_danger((_arg_seg.cat.along - state.along), state.v_)) @as(f64, @bitCast(@as(i64, 0))) else a_)) else a_) else a_);
}
...
fn get_forward_accel_decel(state: RiderState, _arg_seg: Segment) f64 {
    return b0: { const a0: f64 = @as(f64, (if ((real_abs(state.tilt) >= tilt_hold())) @as(f64, @bitCast(@as(i64, 0))) else a_accel())); break :b0 b1: { const v_end: f64 = @as(f64, (if (_arg_seg.terminates) @as(f64, @bitCast(@as(i64, 0))) else turn_speed(_arg_seg.exit_angle))); break :b1 b2: { const near_1: bool = ((_arg_seg.length - state.along) <= approach_intersection_dist()); break :b2 b3: { const a1: f64 = (if (near_1) corner_brake(state, _arg_seg, v_end, a0) else a0); break :b3 b4: { const a3: f64 = pig_gate(state, _arg_seg, cat_gate(state, _arg_seg, a1)); break :b4 b5: { const a4: f64 = shoulder_brake(state, _arg_seg, a3); break :b5 (clamp_v(state, _arg_seg, v_end, (state.v_ + a4), near_1) - state.v_); }; }; }; }; }; };
}
...
fn fixed_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ tilt_hold(), brake_decay(), (tilt_hold() / deg()) });
}

fn fixed_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4585191390103903545))), @as(f64, @bitCast(@as(i64, 4626322717216342016))), @as(f64, @bitCast(@as(i64, 4611686018427387904))) });
}
...
fn rider_at(across: f64, along: f64, v_: f64, tilt: f64) RiderState {
...
fn rider(along: f64, v_: f64, tilt: f64) RiderState {
    return rider_at(@as(f64, @bitCast(@as(i64, 0))), along, v_, tilt);
}

fn corner_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ corner_brake(rider(@as(f64, @bitCast(@as(i64, 4647475561716147814))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4576918229304087675)))), corner_brake(rider(@as(f64, @bitCast(@as(i64, 4648488871632306176))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4576918229304087675)))), corner_brake(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4617315517961601024))))) });
}

fn corner_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))) });
}

fn corner_min_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ (corner_brake(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4576918229304087675)))) <= @as(f64, @bitCast(@as(i64, 4576918229304087675)))), (corner_brake(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4617315517961601024))))) <= (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4617315517961601024))))), (corner_brake(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4576918229304087675)))) < corner_brake(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4576918229304087675))))) });
}

fn corner_min_want() *CxList(bool) {
...
fn cat_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ cat_gate(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4576918229304087675)))), cat_gate(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4617315517961601024))))), cat_gate(rider(@as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), cat_seg(), @as(f64, @bitCast(@as(i64, 4576918229304087675)))), cat_gate(rider(@as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), cat_seg(), (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4617315517961601024))))), cat_gate(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), cat_seg(), @as(f64, @bitCast(@as(i64, 4576918229304087675)))) });
}

fn cat_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4576918229304087675))), (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), @as(f64, @bitCast(@as(i64, 0))), (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), @as(f64, @bitCast(@as(i64, 4576918229304087675))) });
}

fn outcome(sh: Shoulder) ArcOutcome {
    return cx_new(ArcOutcomeS{ .shoulder = sh, .forward = @as(f64, @bitCast(@as(i64, 4621819117588971520))), .crossed = false, .end_across = @as(f64, @bitCast(@as(i64, 0))), .frames = @as(f64, @bitCast(@as(i64, 4630826316843712512))) });
}

fn road_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ stayed_on_road(outcome(Shoulder.ShoulderNone)), stayed_on_road(outcome(Shoulder.ShoulderLeft)), stayed_on_road(outcome(Shoulder.ShoulderRight)) });
}

fn road_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, false, false });
}

fn soon() ArcOutcome {
    return cx_new(ArcOutcomeS{ .shoulder = Shoulder.ShoulderLeft, .forward = @as(f64, @bitCast(@as(i64, 4621819117588971520))), .crossed = false, .end_across = @as(f64, @bitCast(@as(i64, 0))), .frames = @as(f64, @bitCast(@as(i64, 4611686018427387904))) });
}

fn brake_got() *CxList(bool) {
    return b0: { const far: f64 = shoulder_brake_at(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 0)))), outcome(Shoulder.ShoulderLeft), @as(f64, @bitCast(@as(i64, 4576918229304087675)))); break :b0 b1: { const near_off: f64 = shoulder_brake_at(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 0)))), soon(), @as(f64, @bitCast(@as(i64, 4576918229304087675)))); break :b1 b2: { const already: f64 = shoulder_brake_at(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 0)))), outcome(Shoulder.ShoulderLeft), (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4621256167635550208))))); break :b2 cx_ll_of(bool, &[_]bool{ (far < @as(f64, @bitCast(@as(i64, 0)))), (far > near_off), (already < (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4621255604685596787))))) }); }; }; };
}

fn brake_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true });
}

fn instant() ArcOutcome {
    return cx_new(ArcOutcomeS{ .shoulder = Shoulder.ShoulderLeft, .forward = @as(f64, @bitCast(@as(i64, 0))), .crossed = false, .end_across = @as(f64, @bitCast(@as(i64, 0))), .frames = @as(f64, @bitCast(@as(i64, 0))) });
}

fn zero_frames_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ (shoulder_brake_at(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 0)))), instant(), @as(f64, @bitCast(@as(i64, 4576918229304087675)))) < @as(f64, @bitCast(@as(i64, 0)))) });
}

fn zero_frames_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true });
}

fn clamp_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ clamp_v(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), false), clamp_v(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4613937818241073152))), false), clamp_v(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4607182418800017408)))), false), clamp_v(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4591870180066957722))), true), clamp_v(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), true), clamp_v(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), seg(), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4591870180066957722))), false) });
}

fn clamp_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4591870180066957722))) });
}

fn decide(along: f64, v_: f64, tilt: f64) f64 {
    return get_forward_accel_decel(rider(along, v_, tilt), seg());
}

fn whole_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ decide(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0)))), decide(@as(f64, @bitCast(@as(i64, 0))), v_max(), @as(f64, @bitCast(@as(i64, 0)))), decide(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))) });
}

fn whole_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4576918229304087675))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4576918229304087675))) });
}

fn wide(tilt: f64) f64 {
    return get_forward_accel_decel(rider_at(@as(f64, @bitCast(@as(i64, 4636737291354636288))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), tilt), seg());
}

fn tilt_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ wide((@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4562254508917369340))))), wide((@as(f64, @bitCast(@as(i64, 0))) - tilt_hold())), wide(((@as(f64, @bitCast(@as(i64, 0))) - tilt_hold()) - @as(f64, @bitCast(@as(i64, 4602678819172646912))))) });
}

fn tilt_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4576918229304087675))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn compose_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ (decide(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), (tilt_hold() - @as(f64, @bitCast(@as(i64, 4562254508917369340))))) < @as(f64, @bitCast(@as(i64, 0)))), (decide(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 4562254508917369340)))) > @as(f64, @bitCast(@as(i64, 0)))), (decide(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), (@as(f64, @bitCast(@as(i64, 0))) - (tilt_hold() - @as(f64, @bitCast(@as(i64, 4562254508917369340)))))) < @as(f64, @bitCast(@as(i64, 0)))) });
}

fn compose_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x0e\x14\x49\x1c\x11\x24\x0d\x16\x02", fixed_got(), fixed_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_reals("\x0e\x14\x49\x18\x10\x15\x12\x0d\x15", corner_got(), corner_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x0e\x14\x49\x18\x1a\x11\x12\x02\x02", corner_min_got(), corner_min_want())); _ = cx_print_line(grade_reals("\x0e\x14\x49\x18\x0f\x0e\x02\x02\x02", cat_got(), cat_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x0e\x14\x49\x15\x10\x0f\x16\x02\x02", road_got(), road_want())); _ = cx_print_line(grade_bools("\x0e\x14\x49\x20\x15\x0f\x22\x0d\x02", brake_got(), brake_want())); _ = cx_print_line(grade_bools("\x0e\x14\x49\x26\x0d\x15\x10\x02\x02", zero_frames_got(), zero_frames_want())); _ = cx_print_line(grade_reals("\x0e\x14\x49\x18\x17\x0f\x1a\x1f\x02", clamp_got(), clamp_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0e\x14\x49\x1b\x14\x10\x17\x0d\x02", whole_got(), whole_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_reals("\x0e\x14\x49\x0e\x11\x17\x0e\x02\x02", tilt_got(), tilt_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_bools("\x0e\x14\x49\x18\x10\x1a\x1f\x02\x02", compose_got(), compose_want())); break :b0; };
}

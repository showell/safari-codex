...
fn rider(segment: i64, along: f64, tilt: f64, focus: f64) RiderState {
    return cx_new(RiderStateS{ .segment = segment, .along = along, .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .v_ = v_base(), .tilt = tilt, .heading = @as(f64, @bitCast(@as(i64, 0))), .gaze_yaw = @as(f64, @bitCast(@as(i64, 0))), .focus = focus });
}

fn has_cat_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ cx_list_at(segs(), 0).has_cat, cx_list_at(segs(), 1).has_cat });
}

fn has_cat_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, true });
}

fn idle_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (ride_focal(segs(), rider(0, @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))))) - focal()), cat_attention(segs(), rider(0, @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))))), gaze_focus(@as(f64, @bitCast(@as(i64, 0)))), (cam_focal(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))) - focal()) });
}

fn idle_want() *CxList(f64) {
...
fn leaned(tilt: f64) f64 {
    return ride_focal(segs(), rider(0, @as(f64, @bitCast(@as(i64, 0))), tilt, @as(f64, @bitCast(@as(i64, 0)))));
}

fn lean_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ (leaned((max_lean() / @as(f64, @bitCast(@as(i64, 4611686018427387904))))) < leaned(@as(f64, @bitCast(@as(i64, 0))))), (leaned(max_lean()) < leaned((max_lean() / @as(f64, @bitCast(@as(i64, 4611686018427387904)))))), (leaned((@as(f64, @bitCast(@as(i64, 0))) - max_lean())) < leaned(@as(f64, @bitCast(@as(i64, 0))))), (leaned(@as(f64, @bitCast(@as(i64, 0)))) <= focal()) });
}

fn lean_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true, true });
}

fn clamp_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (leaned(max_lean()) - leaned((@as(f64, @bitCast(@as(i64, 0))) - max_lean()))), (leaned((max_lean() * @as(f64, @bitCast(@as(i64, 4611686018427387904))))) - leaned(max_lean())), (leaned((max_lean() * @as(f64, @bitCast(@as(i64, 4621819117588971520))))) - leaned(max_lean())) });
}
...
fn cat_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ (cat_attention(segs(), rider(1, @as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))))) > @as(f64, @bitCast(@as(i64, 0)))), (cat_attention(segs(), rider(1, @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))))) > @as(f64, @bitCast(@as(i64, 0)))), (cat_attention(segs(), rider(0, @as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))))) > @as(f64, @bitCast(@as(i64, 0)))), (ride_focal(segs(), rider(1, @as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))))) < ride_focal(segs(), rider(0, @as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))))) });
}

fn cat_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, false, false, true });
}

fn gaze_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ (ride_focal(segs(), rider(0, @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))))) < ride_focal(segs(), rider(0, @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))))), (ride_focal(segs(), rider(0, @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))))) < ride_focal(segs(), rider(0, @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4602678819172646912)))))), (gaze_focus(@as(f64, @bitCast(@as(i64, 4607182418800017408)))) > gaze_focus(@as(f64, @bitCast(@as(i64, 0))))) });
}

fn gaze_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true });
}

fn both() f64 {
    return ride_focal(segs(), rider(0, @as(f64, @bitCast(@as(i64, 0))), max_lean(), @as(f64, @bitCast(@as(i64, 4607182418800017408)))));
}

fn lean_only() f64 {
    return ride_focal(segs(), rider(0, @as(f64, @bitCast(@as(i64, 0))), max_lean(), @as(f64, @bitCast(@as(i64, 0)))));
}

fn gaze_only() f64 {
    return ride_focal(segs(), rider(0, @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408)))));
}

fn min_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ (both() <= lean_only()), (both() <= gaze_only()), (both() == real_min(lean_only(), gaze_only())), ((lean_only() + gaze_only()) > both()) });
}

fn min_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true, true });
}

fn is_one_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (both() - real_min(lean_only(), gaze_only())), (cam_focal(@as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 0)))) - lean_only()) });
}

fn is_one_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_bools("\x15\x1c\x49\x14\x0f\x13\x18\x0f\x0e", has_cat_got(), has_cat_want())); _ = cx_print_line(grade_reals("\x15\x1c\x49\x11\x16\x17\x0d\x02\x02", idle_got(), idle_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x15\x1c\x49\x17\x0d\x0f\x12\x02\x02", lean_got(), lean_want())); _ = cx_print_line(grade_reals("\x15\x1c\x49\x18\x17\x0f\x1a\x1f\x02", clamp_got(), clamp_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x15\x1c\x49\x18\x0f\x0e\x02\x02\x02", cat_got(), cat_want())); _ = cx_print_line(grade_bools("\x15\x1c\x49\x1d\x0f\x26\x0d\x02\x02", gaze_got(), gaze_want())); _ = cx_print_line(grade_bools("\x15\x1c\x49\x1a\x11\x12\x02\x02\x02", min_got(), min_want())); _ = cx_print_line(grade_reals("\x15\x1c\x49\x11\x13\x10\x12\x0d\x02", is_one_got(), is_one_want(), @as(f64, @bitCast(@as(i64, 0))))); break :b0; };
}

...
fn fixed_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ no_frames(), straighten_margin(), min_forward_progress() });
}

fn fixed_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4741671816366391296))), @as(f64, @bitCast(@as(i64, 4587366580439587226))), @as(f64, @bitCast(@as(i64, 4627730092099895296))) });
}

fn steps_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ turn_danger_steps() });
}

fn steps_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 2000 });
}
...
fn rider(across: f64, tilt: f64, v_: f64) RiderState {
    return cx_new(RiderStateS{ .segment = 0, .along = @as(f64, @bitCast(@as(i64, 0))), .across = across, .yaw = @as(f64, @bitCast(@as(i64, 0))), .v_ = v_, .tilt = tilt, .heading = @as(f64, @bitCast(@as(i64, 0))), .gaze_yaw = @as(f64, @bitCast(@as(i64, 0))), .focus = @as(f64, @bitCast(@as(i64, 0))) });
}

fn side(o_: ArcOutcome) i64 {
    return @as(i64, switch (o_.shoulder) { .ShoulderLeft => -1, .ShoulderNone => 0, .ShoulderRight => 1,  });
}

fn straight() ArcOutcome {
    return project_arc(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), v_base()), seg());
}

fn straight_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ straight().forward, straight().end_across, straight().frames });
}

fn straight_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4627730092099895296))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4741671816366391296))) });
}

fn wide() ArcOutcome {
    return project_arc(rider(@as(f64, @bitCast(@as(i64, 4613937818241073152))), @as(f64, @bitCast(@as(i64, 0))), v_base()), seg());
}

fn wide_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ wide().forward, wide().end_across, wide().frames });
}

fn wide_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4627730092099895296))), @as(f64, @bitCast(@as(i64, 4613937818241073152))), @as(f64, @bitCast(@as(i64, 4741671816366391296))) });
}

fn stopped() ArcOutcome {
    return project_arc(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), seg());
}

fn stopped_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ stopped().forward, stopped().end_across, stopped().frames });
}

fn stopped_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4741671816366391296))) });
}

fn none_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ side(straight()), side(wide()), side(stopped()) });
}

fn none_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 0, 0 });
}

fn crossed_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ straight().crossed, wide().crossed, stopped().crossed });
}

fn crossed_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, false, false });
}

fn leaning() ArcOutcome {
    return project_arc(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4596373779694328218))), v_base()), seg());
}

fn other_way() ArcOutcome {
    return project_arc(rider(@as(f64, @bitCast(@as(i64, 0))), (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4596373779694328218)))), v_base()), seg());
}

fn leaving_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ side(leaning()), side(other_way()) });
}

fn leaving_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1, -1 });
}

fn left_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ (leaning().frames < no_frames()), (leaning().frames < cx_real_from_int(turn_danger_steps())), (leaning().frames > @as(f64, @bitCast(@as(i64, 0)))), (leaning().forward <= min_forward_progress()), (leaning().end_across > @as(f64, @bitCast(@as(i64, 0)))), (other_way().end_across < @as(f64, @bitCast(@as(i64, 0)))), (other_way().frames < no_frames()) });
}

fn left_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true, true, true, true, true });
}

fn mirror_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (leaning().frames - other_way().frames), (leaning().end_across + other_way().end_across) });
}

fn mirror_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn mirror_fwd_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (leaning().forward - other_way().forward) });
}

fn mirror_fwd_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))) });
}

fn step_got() *CxList(f64) {
    return b0: { const a_ = simulate_rider_step(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), v_base()), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))); break :b0 b1: { const b_ = simulate_rider_step(rider(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), v_base()), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4598175219545276416)))); break :b1 cx_ll_of(f64, &[_]f64{ a_.across, a_.yaw, a_.heading, a_.tilt, a_.v_, b_.tilt, b_.v_, b_.yaw, b_.heading, yaw_per_tilt() }); }; };
}

fn step_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4603129179135383962))), @as(f64, @bitCast(@as(i64, 4587366580439587226))), @as(f64, @bitCast(@as(i64, 4587366580439587226))), @as(f64, @bitCast(@as(i64, 4591870180066957722))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x0f\x15\x49\x1c\x11\x24\x0d\x16\x02", fixed_got(), fixed_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x0f\x15\x49\x13\x0e\x0d\x1f\x13\x02", steps_got(), steps_want())); _ = cx_print_line(grade_reals("\x0f\x15\x49\x13\x0e\x15\x0f\x11\x1d", straight_got(), straight_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0f\x15\x49\x1b\x11\x16\x0d\x02\x02", wide_got(), wide_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0f\x15\x49\x13\x0e\x10\x1f\x02\x02", stopped_got(), stopped_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x0f\x15\x49\x12\x10\x12\x0d\x02\x02", none_got(), none_want())); _ = cx_print_line(grade_bools("\x0f\x15\x49\x18\x15\x10\x13\x13\x02", crossed_got(), crossed_want())); _ = cx_print_line(grade_ints("\x0f\x15\x49\x13\x11\x16\x0d\x02\x02", leaving_got(), leaving_want())); _ = cx_print_line(grade_bools("\x0f\x15\x49\x17\x0d\x1c\x0e\x02\x02", left_got(), left_want())); _ = cx_print_line(grade_reals("\x0f\x15\x49\x1a\x11\x15\x15\x10\x15", mirror_got(), mirror_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0f\x15\x49\x1a\x1c\x1b\x16\x02\x02", mirror_fwd_got(), mirror_fwd_want(), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_reals("\x0f\x15\x49\x13\x0e\x0d\x1f\x02\x02", step_got(), step_want(), @as(f64, @bitCast(@as(i64, 0))))); break :b0; };
}

...
fn fill_cows(bull: bool) *CxList(Critter) {
    return cx_ll_concat(bull_of(bull), cows_from(0));
}
...
fn bull_count_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(bull_of(true)), cx_list_len(bull_of(false)), cx_list_len(fill_cows(true)), cx_list_len(fill_cows(false)), cx_list_at(bull_of(true), 0).codepoint, bull_cp(), cow_cp() });
}

fn bull_count_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1, 0, 15, 14, 128002, 128002, 128004 });
}

fn bull_face_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ cx_list_at(bull_of(true), 0).face_right, cx_list_at(fill_cows(true), 1).face_right });
}

fn bull_face_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, true });
}

fn bull_place_got() *CxList(f64) {
    return b0: { const b_ = cx_list_at(bull_of(true), 0); break :b0 cx_ll_of(f64, &[_]f64{ b_.along, b_.across, bull_dist(), bull_tree_gap() }); };
}

fn bull_place_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4627448617123184640))), (-@as(f64, @bitCast(@as(i64, 4617095967479766712)))), @as(f64, @bitCast(@as(i64, 4627448617123184640))), @as(f64, @bitCast(@as(i64, 4602678819172646912))) });
}

fn height_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ cow_height(), calf_height() });
}

fn height_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4604480259023595110))) });
}

fn bull_height_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ bull_height(), cx_list_at(bull_of(true), 0).height });
}

fn bull_height_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4609929614572713411))), @as(f64, @bitCast(@as(i64, 4609929614572713411))) });
}

fn cows() *CxList(Critter) {
    return cows_from(0);
}

fn cow_of(i_: i64) Critter {
    return cx_list_at(cows(), i_);
}

fn alongs_got() *CxList(f64) {
    return list_map(Critter, f64, b1: { const _Env1 = struct { fn call(_ctx1: *anyopaque, _cp0: Critter) f64 { _ = _ctx1; return __lam_0(_cp0); } }; break :b1 CxFn1(Critter, f64){ .ctx = cx_new(_Env1{  }), .call = &_Env1.call }; }, cows());
}

fn alongs_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4628574517030027264))), @as(f64, @bitCast(@as(i64, 4629137466983448576))), @as(f64, @bitCast(@as(i64, 4629700416936869888))), @as(f64, @bitCast(@as(i64, 4629981891913580544))), @as(f64, @bitCast(@as(i64, 4630263366890291200))), @as(f64, @bitCast(@as(i64, 4630544841867001856))), @as(f64, @bitCast(@as(i64, 4630826316843712512))), @as(f64, @bitCast(@as(i64, 4631107791820423168))), @as(f64, @bitCast(@as(i64, 4631389266797133824))), @as(f64, @bitCast(@as(i64, 4631670741773844480))), @as(f64, @bitCast(@as(i64, 4631952216750555136))), @as(f64, @bitCast(@as(i64, 4632233691727265792))), @as(f64, @bitCast(@as(i64, 4632515166703976448))), @as(f64, @bitCast(@as(i64, 4632796641680687104))) });
}

fn acrosses_got() *CxList(f64) {
    return list_map(Critter, f64, b1: { const _Env1 = struct { fn call(_ctx1: *anyopaque, _cp0: Critter) f64 { _ = _ctx1; return __lam_1(_cp0); } }; break :b1 CxFn1(Critter, f64){ .ctx = cx_new(_Env1{  }), .call = &_Env1.call }; }, cows());
}

fn acrosses_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4622945017495814144)))), (-@as(f64, @bitCast(@as(i64, 4625478292286210048)))), (-@as(f64, @bitCast(@as(i64, 4626885667169763328)))), (-@as(f64, @bitCast(@as(i64, 4622945017495814144)))), (-@as(f64, @bitCast(@as(i64, 4625478292286210048)))), (-@as(f64, @bitCast(@as(i64, 4626885667169763328)))), (-@as(f64, @bitCast(@as(i64, 4622945017495814144)))), (-@as(f64, @bitCast(@as(i64, 4625478292286210048)))), (-@as(f64, @bitCast(@as(i64, 4626885667169763328)))), (-@as(f64, @bitCast(@as(i64, 4622945017495814144)))), (-@as(f64, @bitCast(@as(i64, 4625478292286210048)))), (-@as(f64, @bitCast(@as(i64, 4626885667169763328)))), (-@as(f64, @bitCast(@as(i64, 4622945017495814144)))), (-@as(f64, @bitCast(@as(i64, 4625478292286210048)))) });
}

fn calves_got() *CxList(f64) {
    return list_map(Critter, f64, b1: { const _Env1 = struct { fn call(_ctx1: *anyopaque, _cp0: Critter) f64 { _ = _ctx1; return __lam_2(_cp0); } }; break :b1 CxFn1(Critter, f64){ .ctx = cx_new(_Env1{  }), .call = &_Env1.call }; }, cows());
}

fn calves_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4604480259023595110))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4604480259023595110))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4604480259023595110))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4604480259023595110))) });
}

fn kind_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(cows()), cow_of(0).codepoint, cow_of(13).codepoint });
}

fn kind_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 14, 128004, 128004 });
}

fn order_got() *CxList(f64) {
    return b0: { const all = fill_cows(true); break :b0 cx_ll_of(f64, &[_]f64{ cx_list_at(all, 0).along, (cx_list_at(all, 1).along - cow_of(0).along), (cx_list_at(all, 14).along - cow_of(13).along) }); };
}

fn order_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4627448617123184640))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn spacing_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ herd_gap_behind_bull(), herd_col_spacing(), herd_row_stagger(), herd_row_depth(), herd_jitter_along(), herd_jitter_across() });
}

fn spacing_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4618441417868443648))), @as(f64, @bitCast(@as(i64, 4618441417868443648))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4617315517961601024))), @as(f64, @bitCast(@as(i64, 4609434218613702656))), @as(f64, @bitCast(@as(i64, 4608083138725491507))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_ints("\x14\x16\x49\x20\x19\x17\x17\x02\x02", bull_count_got(), bull_count_want())); _ = cx_print_line(grade_bools("\x14\x16\x49\x1c\x0f\x18\x0d\x02\x02", bull_face_got(), bull_face_want())); _ = cx_print_line(grade_reals("\x14\x16\x49\x1f\x17\x0f\x18\x0d\x02", bull_place_got(), bull_place_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x14\x16\x49\x14\x0d\x11\x1d\x14\x0e", height_got(), height_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x14\x16\x49\x20\x19\x17\x17\x14\x02", bull_height_got(), bull_height_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_reals("\x14\x16\x49\x18\x0f\x17\x21\x0d\x13", calves_got(), calves_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x14\x16\x49\x22\x11\x12\x16\x02\x02", kind_got(), kind_want())); _ = cx_print_line(grade_reals("\x14\x16\x49\x10\x15\x16\x0d\x15\x02", order_got(), order_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x14\x16\x49\x13\x1f\x0f\x18\x0d\x02", spacing_got(), spacing_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x14\x16\x49\x0f\x17\x10\x12\x1d\x02", alongs_got(), alongs_want(), @as(f64, @bitCast(@as(i64, 4609434218613702656))))); _ = cx_print_line(grade_reals("\x14\x16\x49\x0f\x18\x15\x10\x13\x13", acrosses_got(), acrosses_want(), @as(f64, @bitCast(@as(i64, 4608083138725491507))))); break :b0; };
}

fn __lam_0(c_: Critter) f64 {
    return c_.along;
}

fn __lam_1(c_: Critter) f64 {
    return c_.across;
}

fn __lam_2(c_: Critter) f64 {
    return c_.height;
}

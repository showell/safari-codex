...
fn pts_a() *CxList(RiderPt) {
    return cx_ll_of(RiderPt, &[_]RiderPt{ cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 0))), .forward = @as(f64, @bitCast(@as(i64, 0))) }), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 4613937818241073152))), .forward = @as(f64, @bitCast(@as(i64, 4621819117588971520))) }), cx_new(RiderPtS{ .right = (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), .forward = @as(f64, @bitCast(@as(i64, 4630826316843712512))) }), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 4623226492472524800))), .forward = @as(f64, @bitCast(@as(i64, 4636737291354636288))) }) });
}

fn height_got() *CxList(f64) {
    return list_map(Vec3, f64, b1: { const _Env1 = struct { fn call(_ctx1: *anyopaque, _cp0: Vec3) f64 { _ = _ctx1; return __lam_0(_cp0); } }; break :b1 CxFn1(Vec3, f64){ .ctx = cx_new(_Env1{  }), .call = &_Env1.call }; }, ground_verts(pts_a(), 0));
}
...
fn carry_got() *CxList(f64) {
    return b0: { const vs_ = ground_verts(pts_a(), 0); break :b0 cx_ll_of(f64, &[_]f64{ cx_list_at(vs_, 1).right, cx_list_at(vs_, 1).forward, cx_list_at(vs_, 3).right, cx_list_at(vs_, 3).forward }); };
}

fn carry_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4613937818241073152))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4623226492472524800))), @as(f64, @bitCast(@as(i64, 4636737291354636288))) });
}

fn quad() *CxList(RiderPt) {
    return cx_ll_of(RiderPt, &[_]RiderPt{ cx_new(RiderPtS{ .right = (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), .forward = @as(f64, @bitCast(@as(i64, 4621819117588971520))) }), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 4617315517961601024))), .forward = @as(f64, @bitCast(@as(i64, 4621819117588971520))) }), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 4617315517961601024))), .forward = @as(f64, @bitCast(@as(i64, 4626322717216342016))) }), cx_new(RiderPtS{ .right = (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), .forward = @as(f64, @bitCast(@as(i64, 4626322717216342016))) }) });
}

fn behind() *CxList(RiderPt) {
    return cx_ll_of(RiderPt, &[_]RiderPt{ cx_new(RiderPtS{ .right = (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), .forward = (-@as(f64, @bitCast(@as(i64, 4621819117588971520)))) }), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 4617315517961601024))), .forward = (-@as(f64, @bitCast(@as(i64, 4621819117588971520)))) }), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 4617315517961601024))), .forward = (-@as(f64, @bitCast(@as(i64, 4626322717216342016)))) }), cx_new(RiderPtS{ .right = (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), .forward = (-@as(f64, @bitCast(@as(i64, 4626322717216342016)))) }) });
}

fn two_points() *CxList(RiderPt) {
    return cx_ll_of(RiderPt, &[_]RiderPt{ cx_new(RiderPtS{ .right = (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), .forward = @as(f64, @bitCast(@as(i64, 4621819117588971520))) }), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 4617315517961601024))), .forward = @as(f64, @bitCast(@as(i64, 4621819117588971520))) }) });
}

fn wide(n_: i64) *CxList(RiderPt) {
    return (if ((n_ <= 0)) cx_ll_empty(RiderPt) else cx_ll_concat(cx_ll_of(RiderPt, &[_]RiderPt{ cx_new(RiderPtS{ .right = cx_real_from_int(n_), .forward = (@as(f64, @bitCast(@as(i64, 4621819117588971520))) + cx_real_from_int(n_)) }) }), wide((n_ - 1))));
}

fn drawn(ps: *CxList(RiderPt)) *CxList(DrawCmd) {
    return emit_ground_color(ps, 3112588, @as(f64, @bitCast(@as(i64, 4649241034723037974))), @as(f64, @bitCast(@as(i64, 4651655465120301056))));
}

fn count_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(drawn(quad())), cx_list_len(drawn(wide(8))), cx_list_len(drawn(wide(9))), cx_list_len(drawn(behind())), cx_list_len(drawn(two_points())) });
}

fn count_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1, 1, 0, 0, 0 });
}

fn cmd_got() *CxList(i64) {
    return b0: { const c_ = cx_list_at(drawn(quad()), 0); break :b0 cx_ll_of(i64, &[_]i64{ c_.tag, c_.color, c_.color2, cx_list_len(c_.pts), cx_list_len(c_.geom) }); };
}

fn cmd_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 3112588, 0, 8, 0 });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x1d\x15\x49\x14\x0d\x11\x1d\x14\x0e", height_got(), height_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x1d\x15\x49\x18\x0f\x15\x15\x1e\x02", carry_got(), carry_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x1d\x15\x49\x18\x10\x19\x12\x0e\x02", count_got(), count_want())); _ = cx_print_line(grade_ints("\x1d\x15\x49\x18\x1a\x16\x02\x02\x02", cmd_got(), cmd_want())); break :b0; };
}

fn __lam_0(v_: Vec3) f64 {
    return v_.height;
}

...
fn probe() RiderState {
    return cx_new(RiderStateS{ .segment = 7, .along = @as(f64, @bitCast(@as(i64, 4622382067542392832))), .across = @as(f64, @bitCast(@as(i64, 4612811918334230528))), .yaw = @as(f64, @bitCast(@as(i64, 4604930618986332160))), .v_ = @as(f64, @bitCast(@as(i64, 4614500768194494464))), .tilt = @as(f64, @bitCast(@as(i64, 4593671619917905920))), .heading = @as(f64, @bitCast(@as(i64, 4616752568008179712))), .gaze_yaw = @as(f64, @bitCast(@as(i64, 4600427019358961664))), .focus = @as(f64, @bitCast(@as(i64, 4619285842798575616))) });
}

fn new_tilt() f64 {
    return @as(f64, @bitCast(@as(i64, 4621537642612260864)));
}

fn reals(s_: RiderState) *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ s_.along, s_.across, s_.yaw, s_.v_, s_.tilt, s_.heading, s_.gaze_yaw, s_.focus });
}

fn seg(s_: RiderState) *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ s_.segment });
}

fn init_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn init_seg_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0 });
}

fn tilt_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4622382067542392832))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 4604930618986332160))), @as(f64, @bitCast(@as(i64, 4614500768194494464))), @as(f64, @bitCast(@as(i64, 4621537642612260864))), @as(f64, @bitCast(@as(i64, 4616752568008179712))), @as(f64, @bitCast(@as(i64, 4600427019358961664))), @as(f64, @bitCast(@as(i64, 4619285842798575616))) });
}

fn tilt_seg_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 7 });
}

fn twice_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4622382067542392832))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 4604930618986332160))), @as(f64, @bitCast(@as(i64, 4614500768194494464))), @as(f64, @bitCast(@as(i64, 4621537642612260864))), @as(f64, @bitCast(@as(i64, 4616752568008179712))), @as(f64, @bitCast(@as(i64, 4600427019358961664))), @as(f64, @bitCast(@as(i64, 4619285842798575616))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x1f\x49\x11\x12\x11\x0e\x02\x02", reals(initial_rider_state()), init_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x1f\x49\x11\x12\x11\x0e\x13\x1d", seg(initial_rider_state()), init_seg_want())); _ = cx_print_line(grade_reals("\x1f\x49\x0e\x11\x17\x0e\x02\x02", reals(with_tilt(probe(), new_tilt())), tilt_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x1f\x49\x0e\x11\x17\x0e\x13\x1d", seg(with_tilt(probe(), new_tilt())), tilt_seg_want())); _ = cx_print_line(grade_reals("\x1f\x49\x0e\x1b\x11\x18\x0d\x02", reals(with_tilt(with_tilt(probe(), @as(f64, @bitCast(@as(i64, 4609434218613702656)))), new_tilt())), twice_want(), @as(f64, @bitCast(@as(i64, 0))))); break :b0; };
}

...
fn route_shape_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(route()), pig_count_to(0, 0), pig_count_to(3, 0), pig_count_to(11, 0), pig_count_to(12, 0), pig_count_to(19, 0) });
}

fn route_shape_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 19, 0, 1, 2, 3, 9 });
}

fn headings_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (heading_at(0) / deg()), (heading_at(1) / deg()), (heading_at(2) / deg()), (heading_at(3) / deg()), (heading_at(4) / deg()), (heading_at(5) / deg()), (heading_at(6) / deg()), (heading_at(7) / deg()), (heading_at(8) / deg()), (heading_at(9) / deg()), (heading_at(10) / deg()), (heading_at(11) / deg()), (heading_at(12) / deg()), (heading_at(13) / deg()), (heading_at(14) / deg()), (heading_at(15) / deg()), (heading_at(16) / deg()), (heading_at(17) / deg()), (heading_at(18) / deg()) });
}

fn headings_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4632233691727265792))), (-@as(f64, @bitCast(@as(i64, 4626322717216342016)))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4626322717216342016))), (-@as(f64, @bitCast(@as(i64, 4632233691727265792)))), (-@as(f64, @bitCast(@as(i64, 4638144666238189568)))), (-@as(f64, @bitCast(@as(i64, 4630826316843712512)))), (-@as(f64, @bitCast(@as(i64, 4627730092099895296)))), (-@as(f64, @bitCast(@as(i64, 4636385447633747968)))), (-@as(f64, @bitCast(@as(i64, 4635329916471083008)))), (-@as(f64, @bitCast(@as(i64, 4634274385308418048)))), (-@as(f64, @bitCast(@as(i64, 4632233691727265792)))), (-@as(f64, @bitCast(@as(i64, 4630122629401935872)))), (-@as(f64, @bitCast(@as(i64, 4635681760191971328)))), (-@as(f64, @bitCast(@as(i64, 4630122629401935872)))), (-@as(f64, @bitCast(@as(i64, 4635681760191971328)))), (-@as(f64, @bitCast(@as(i64, 4630122629401935872)))), (-@as(f64, @bitCast(@as(i64, 4635681760191971328)))) });
}

fn steps_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (heading_step(0) / deg()), (heading_step(1) / deg()), (heading_step(6) / deg()), (heading_step(18) / deg()) });
}

fn steps_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4632233691727265792))), (-@as(f64, @bitCast(@as(i64, 4634626229029306368)))), @as(f64, @bitCast(@as(i64, 4635329916471083008))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn seg(i_: i64) Segment {
    return segment_at(i_);
}

fn length_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ seg(0).length, seg(1).length, seg(6).length, seg(9).length, seg(18).length, seg(0).width, seg(18).width });
}

fn length_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4644337115725824000))), @as(f64, @bitCast(@as(i64, 4652992471259676672))), @as(f64, @bitCast(@as(i64, 4650248090236747776))), @as(f64, @bitCast(@as(i64, 4643985272004935680))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4616189618054758400))) });
}

fn exit_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ seg(0).exit_to, seg(1).exit_to, seg(17).exit_to, seg(18).exit_to });
}

fn exit_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1, 2, 18, 18 });
}

fn flags_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ seg(0).terminates, seg(18).terminates, seg(0).exit_right, seg(1).exit_right, seg(6).exit_right, seg(18).exit_right, seg(0).has_mid_tower, seg(6).has_mid_tower, seg(9).has_mid_tower, seg(0).has_cat, seg(1).has_cat, seg(12).has_cat, seg(18).has_cat });
}

fn flags_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, true, true, false, true, true, false, true, false, false, true, true, true });
}

fn angle_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (seg(0).exit_angle / deg()), (seg(1).exit_angle / deg()), (seg(6).exit_angle / deg()), (seg(18).exit_angle / deg()), seg(18).commit_along });
}

fn angle_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4632233691727265792))), @as(f64, @bitCast(@as(i64, 4634626229029306368))), @as(f64, @bitCast(@as(i64, 4635329916471083008))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4643985272004935680))) });
}

fn commit_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ seg(0).commit_along, seg(1).commit_along, seg(6).commit_along });
}

fn commit_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647474186020175937))), @as(f64, @bitCast(@as(i64, 4644324309661672319))), @as(f64, @bitCast(@as(i64, 4652990920271152035))) });
}

fn pigs_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(seg(0).pigs), cx_list_len(seg(2).pigs), cx_list_len(seg(10).pigs), cx_list_len(seg(11).pigs), cx_list_len(seg(13).pigs), cx_list_len(seg(18).pigs) });
}

fn pigs_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 49, 49, 10, 10, 10 });
}

fn distract_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ seg(0).pigs_distract, seg(2).pigs_distract, seg(10).pigs_distract, seg(11).pigs_distract, seg(18).pigs_distract });
}

fn distract_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, true, true, false, false });
}

fn cows_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(seg(0).cows), cx_list_len(seg(3).cows), cx_list_len(seg(4).cows), cx_list_len(seg(18).cows) });
}

fn cows_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 14, 14, 15, 15 });
}

fn trees_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(seg(0).trees), cx_list_len(seg(1).trees), cx_list_len(seg(6).trees), cx_list_len(seg(18).trees) });
}

fn trees_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 28, 16, 74, 14 });
}

fn cat_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ seg(0).cat.mid_across, seg(18).cat.mid_across, seg(0).cat.height, seg(18).cat.height });
}

fn cat_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4605525094137145065))), @as(f64, @bitCast(@as(i64, 4605525094137145065))), @as(f64, @bitCast(@as(i64, 4610334938539176755))), @as(f64, @bitCast(@as(i64, 4610334938539176755))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_ints("\x1b\x10\x49\x13\x14\x0f\x1f\x0d\x02", route_shape_got(), route_shape_want())); _ = cx_print_line(grade_reals("\x1b\x10\x49\x14\x0d\x0f\x16\x02\x02", headings_got(), headings_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_reals("\x1b\x10\x49\x13\x0e\x0d\x1f\x02\x02", steps_got(), steps_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_reals("\x1b\x10\x49\x17\x0d\x12\x1d\x0e\x14", length_got(), length_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x1b\x10\x49\x0d\x24\x11\x0e\x02\x02", exit_got(), exit_want())); _ = cx_print_line(grade_bools("\x1b\x10\x49\x1c\x17\x0f\x1d\x13\x02", flags_got(), flags_want())); _ = cx_print_line(grade_reals("\x1b\x10\x49\x0f\x12\x1d\x17\x0d\x02", angle_got(), angle_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_reals("\x1b\x10\x49\x18\x10\x1a\x1a\x11\x0e", commit_got(), commit_want(), @as(f64, @bitCast(@as(i64, 4487126258331716666))))); _ = cx_print_line(grade_ints("\x1b\x10\x49\x1f\x11\x1d\x13\x02\x02", pigs_got(), pigs_want())); _ = cx_print_line(grade_bools("\x1b\x10\x49\x16\x11\x13\x0e\x15\x02", distract_got(), distract_want())); _ = cx_print_line(grade_ints("\x1b\x10\x49\x18\x10\x1b\x13\x02\x02", cows_got(), cows_want())); _ = cx_print_line(grade_ints("\x1b\x10\x49\x0e\x15\x0d\x0d\x13\x02", trees_got(), trees_want())); _ = cx_print_line(grade_reals("\x1b\x10\x49\x18\x0f\x0e\x02\x02\x02", cat_got(), cat_want(), @as(f64, @bitCast(@as(i64, 0))))); break :b0; };
}

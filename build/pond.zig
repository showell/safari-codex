...
fn g_water_outline() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), @as(f64, @bitCast(@as(i64, 4613937818241073152))), (-@as(f64, @bitCast(@as(i64, 4628574517030027264)))), @as(f64, @bitCast(@as(i64, 4613937818241073152))), (-@as(f64, @bitCast(@as(i64, 4629418941960159232)))), @as(f64, @bitCast(@as(i64, 4624070917402656768))), (-@as(f64, @bitCast(@as(i64, 4628011567076605952)))), @as(f64, @bitCast(@as(i64, 4628574517030027264))), (-@as(f64, @bitCast(@as(i64, 4624633867356078080)))), @as(f64, @bitCast(@as(i64, 4629700416936869888))), (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), @as(f64, @bitCast(@as(i64, 4628855992006737920))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), @as(f64, @bitCast(@as(i64, 4625196817309499392))) });
}

fn g_bank() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), @as(f64, @bitCast(@as(i64, 4628855992006737920))), (-@as(f64, @bitCast(@as(i64, 4624633867356078080)))), @as(f64, @bitCast(@as(i64, 4629700416936869888))), (-@as(f64, @bitCast(@as(i64, 4628011567076605952)))), @as(f64, @bitCast(@as(i64, 4628574517030027264))), (-@as(f64, @bitCast(@as(i64, 4628011567076605952)))), @as(f64, @bitCast(@as(i64, 4628855992006737920))), (-@as(f64, @bitCast(@as(i64, 4624633867356078080)))), @as(f64, @bitCast(@as(i64, 4629841154425225216))), (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), @as(f64, @bitCast(@as(i64, 4629137466983448576))) });
}

fn g_ducks_p() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4620693217682128896)))), @as(f64, @bitCast(@as(i64, 4622382067542392832))), (-@as(f64, @bitCast(@as(i64, 4625196817309499392)))), @as(f64, @bitCast(@as(i64, 4625478292286210048))), (-@as(f64, @bitCast(@as(i64, 4621256167635550208)))), @as(f64, @bitCast(@as(i64, 4626604192193052672))), (-@as(f64, @bitCast(@as(i64, 4616189618054758400)))), @as(f64, @bitCast(@as(i64, 4618441417868443648))), (-@as(f64, @bitCast(@as(i64, 4622945017495814144)))), @as(f64, @bitCast(@as(i64, 4619567317775286272))), (-@as(f64, @bitCast(@as(i64, 4626322717216342016)))), @as(f64, @bitCast(@as(i64, 4620693217682128896))) });
}

fn g_duck_height() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4606281698874543309))) });
}

fn g_water_color() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 3112588 });
}

fn g_bank_color() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 12759680 });
}

fn g_duck_codepoint() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 129414 });
}

fn g_ducks_face() *CxList(bool) {
...
fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x1b\x0f\x0e\x0d\x15\x49\x10\x19\x0e\x17\x11\x12\x0d\x02", flat_pts(water_outline(), 0), g_water_outline(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x20\x0f\x12\x22\x02\x02\x02\x02\x02\x02\x02\x02\x02\x02", flat_pts(bank(), 0), g_bank(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x16\x19\x18\x22\x13\x49\x1f\x02\x02\x02\x02\x02\x02\x02", flat_duck_pts(ducks(), 0), g_ducks_p(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x16\x19\x18\x22\x49\x14\x0d\x11\x1d\x14\x0e\x02\x02\x02", cx_ll_of(f64, &[_]f64{ duck_height() }), g_duck_height(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x1b\x0f\x0e\x0d\x15\x49\x18\x10\x17\x10\x15\x02\x02\x02", cx_ll_of(i64, &[_]i64{ water_color() }), g_water_color())); _ = cx_print_line(grade_ints("\x20\x0f\x12\x22\x49\x18\x10\x17\x10\x15\x02\x02\x02\x02", cx_ll_of(i64, &[_]i64{ bank_color() }), g_bank_color())); _ = cx_print_line(grade_ints("\x16\x19\x18\x22\x49\x18\x10\x16\x0d\x1f\x10\x11\x12\x0e", cx_ll_of(i64, &[_]i64{ duck_codepoint() }), g_duck_codepoint())); _ = cx_print_line(grade_bools("\x16\x19\x18\x22\x13\x49\x1c\x0f\x18\x0d\x02\x02\x02\x02", duck_faces(ducks(), 0), g_ducks_face())); break :b0; };
}

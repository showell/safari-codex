...
fn horizon_colors(ss: *CxList(f64), i_: i64) *CxList(i64) {
    return (if ((i_ >= cx_list_len(ss))) cx_ll_empty(i64) else cx_ll_concat(cx_ll_of(i64, &[_]i64{ horizon_color(cx_list_at(ss, i_)) }), horizon_colors(ss, (i_ +% 1))));
}

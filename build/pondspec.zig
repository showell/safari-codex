...
fn inside_got() *CxList(bool) {
    return map_list(Duck, bool, b1: { const _Env1 = struct { fn call(_ctx1: *anyopaque, p0: Duck) bool { _ = _ctx1; return inside(p0); } }; break :b1 CxFn1(Duck, bool){ .ctx = cx_new(_Env1{  }), .call = &_Env1.call }; }, ducks());
}

...
fn has_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ cx_list_at(segs(), 0).has_cat, cx_list_at(segs(), 1).has_cat, cx_list_at(segs(), 2).has_cat });
}

fn has_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, true, false });
}

fn gap_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ chain_gap(segs(), chain(), @as(f64, @bitCast(@as(i64, 0))), 0), chain_gap(segs(), chain(), @as(f64, @bitCast(@as(i64, 0))), 1), chain_gap(segs(), chain(), @as(f64, @bitCast(@as(i64, 0))), 2), chain_gap(segs(), chain(), @as(f64, @bitCast(@as(i64, 4638144666238189568))), 0), chain_gap(segs(), chain(), @as(f64, @bitCast(@as(i64, 4638144666238189568))), 1), chain_gap(segs(), chain(), @as(f64, @bitCast(@as(i64, 4638144666238189568))), 2) });
}

fn gap_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4650424012097191936))), (-@as(f64, @bitCast(@as(i64, 4638144666238189568)))), @as(f64, @bitCast(@as(i64, 4645392646888488960))), @as(f64, @bitCast(@as(i64, 4649368480934526976))) });
}

fn riding(a_: f64) *CxList(CatItem) {
    return walk_cats(segs(), chain(), cx_new(PoseS{ .along = a_, .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .hw = @as(f64, @bitCast(@as(i64, 4611686018427387904))) }), @as(f64, @bitCast(@as(i64, 4647503709213818880))), a_, @as(f64, @bitCast(@as(i64, 4607182418800017408))), 0);
}

fn seen() *CxList(CatItem) {
    return riding(@as(f64, @bitCast(@as(i64, 4643985272004935680))));
}

fn count_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(seen()), cx_list_len(seg_cat(segs(), chain(), origin(), 0, @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))))), cx_list_len(seg_cat(segs(), chain(), origin(), 2, @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))))), max_vis_cats() });
}

fn count_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1, 0, 0, 8 });
}

fn place_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ cx_list_at(seen(), 0).height, cx_list_at(seen(), 0).lift });
}

fn place_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4610334938539176755))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn pose_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_at(seen(), 0).pose_idx });
}
...
fn closing_got() *CxList(f64) {
    return b0: { const a_: f64 = cx_list_at(riding(@as(f64, @bitCast(@as(i64, 4641240890982006784)))), 0).fwd; break :b0 b1: { const b_: f64 = cx_list_at(riding(@as(f64, @bitCast(@as(i64, 4643985272004935680)))), 0).fwd; break :b1 b2: { const c_: f64 = cx_list_at(riding(@as(f64, @bitCast(@as(i64, 4645744490609377280)))), 0).fwd; break :b2 cx_ll_of(f64, &[_]f64{ (b_ - a_), (c_ - b_), (cx_list_at(riding(@as(f64, @bitCast(@as(i64, 4643985272004935680)))), 0).right - cx_list_at(riding(@as(f64, @bitCast(@as(i64, 4641240890982006784)))), 0).right) }); }; }; };
}

fn closing_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4636737291354636288)))), (-@as(f64, @bitCast(@as(i64, 4636737291354636288)))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn cull_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(riding(@as(f64, @bitCast(@as(i64, 0))))), cx_list_len(riding(@as(f64, @bitCast(@as(i64, 4641240890982006784))))), cx_list_len(riding(@as(f64, @bitCast(@as(i64, 4647503709213818880))))), cx_list_len(riding(@as(f64, @bitCast(@as(i64, 4648488871632306176))))), cx_list_len(walk_cats(segs(), cx_ll_empty(i64), origin(), @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), 0)), cx_list_len(walk_cats(segs(), cx_ll_of(i64, &[_]i64{ 0 }), origin(), @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), 0)) });
}

fn cull_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 1, 1, 0, 0, 0 });
}

fn items_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(cat_items(seen(), 0)), cx_list_len(cat_items(cx_ll_empty(CatItem), 0)), cx_list_at(cat_items(seen(), 0), 0).i_ });
}

fn items_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1, 0, 0 });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_bools("\x18\x1f\x49\x14\x0f\x13\x02\x02\x02", has_got(), has_want())); _ = cx_print_line(grade_reals("\x18\x1f\x49\x1d\x0f\x1f\x02\x02\x02", gap_got(), gap_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x18\x1f\x49\x18\x10\x19\x12\x0e\x02", count_got(), count_want())); _ = cx_print_line(grade_reals("\x18\x1f\x49\x1f\x17\x0f\x18\x0d\x02", place_got(), place_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x18\x1f\x49\x1f\x10\x13\x0d\x02\x02", pose_got(), pose_want())); _ = cx_print_line(grade_reals("\x18\x1f\x49\x18\x17\x10\x13\x0d\x02", closing_got(), closing_want(), @as(f64, @bitCast(@as(i64, 4547007122018943789))))); _ = cx_print_line(grade_ints("\x18\x1f\x49\x18\x19\x17\x17\x02\x02", cull_got(), cull_want())); _ = cx_print_line(grade_ints("\x18\x1f\x49\x11\x0e\x0d\x1a\x13\x02", items_got(), items_want())); break :b0; };
}

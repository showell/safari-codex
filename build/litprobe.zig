...
fn lits() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4578359381184846241))), @as(f64, @bitCast(@as(i64, 4601021494509774569))), @as(f64, @bitCast(@as(i64, 4605516086937890325))), @as(f64, @bitCast(@as(i64, 4616807174153661580))), @as(f64, @bitCast(@as(i64, 4601300717686671540))), @as(f64, @bitCast(@as(i64, 4595923419731591168))) });
}

fn walk(i_: i64) *CxList(i64) {
    return (if ((i_ >= cx_list_len(lits()))) cx_ll_empty(i64) else cx_ll_concat(cx_ll_of(i64, &[_]i64{ cx_real_to_bits(cx_list_at(lits(), i_)) }), walk((i_ +% 1))));
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_ints("\x17\x11\x0e\x03", cx_ll_of(i64, &[_]i64{ cx_list_at(walk(0), 0) }), cx_ll_of(i64, &[_]i64{ 0 }))); _ = cx_print_line(grade_ints("\x17\x11\x0e\x04", cx_ll_of(i64, &[_]i64{ cx_list_at(walk(0), 1) }), cx_ll_of(i64, &[_]i64{ 0 }))); _ = cx_print_line(grade_ints("\x17\x11\x0e\x05", cx_ll_of(i64, &[_]i64{ cx_list_at(walk(0), 2) }), cx_ll_of(i64, &[_]i64{ 0 }))); _ = cx_print_line(grade_ints("\x17\x11\x0e\x06", cx_ll_of(i64, &[_]i64{ cx_list_at(walk(0), 3) }), cx_ll_of(i64, &[_]i64{ 0 }))); _ = cx_print_line(grade_ints("\x17\x11\x0e\x07", cx_ll_of(i64, &[_]i64{ cx_list_at(walk(0), 4) }), cx_ll_of(i64, &[_]i64{ 0 }))); _ = cx_print_line(grade_ints("\x17\x11\x0e\x08", cx_ll_of(i64, &[_]i64{ cx_list_at(walk(0), 5) }), cx_ll_of(i64, &[_]i64{ 0 }))); break :b0; };
}

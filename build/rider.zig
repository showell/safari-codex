...
fn pig_gaze_brake(state: RiderState, seg: Segment) GazeBrake {
    return (if ((gawk_engaged(state, seg) == false)) cx_new(GazeBrakeS{ .engaged = false, .accel = @as(f64, @bitCast(@as(i64, 0))) }) else (if ((state.v_ <= pig_gaze_speed())) cx_new(GazeBrakeS{ .engaged = true, .accel = @as(f64, @bitCast(@as(i64, 0))) }) else pig_gaze_brake_easing(state, seg)));
}
...
fn clamp_v(state: RiderState, seg: Segment, v_end: f64, v0: f64, near: bool) f64 {
    return b0: { const v1: f64 = (if ((v0 > v_max())) v_max() else v0); break :b0 b1: { const v2: f64 = @as(f64, (if ((v1 < @as(f64, @bitCast(@as(i64, 0))))) @as(f64, @bitCast(@as(i64, 0))) else v1)); break :b1 (if (near) (if ((v2 < v_end)) (if (gawk_engaged(state, seg)) v2 else v_end) else v2) else v2); }; };
}

fn get_forward_accel_decel(state: RiderState, seg: Segment) f64 {
    return b0: { const a0: f64 = @as(f64, (if ((real_abs(state.tilt) >= tilt_hold())) @as(f64, @bitCast(@as(i64, 0))) else a_accel())); break :b0 b1: { const v_end: f64 = @as(f64, (if (seg.terminates) @as(f64, @bitCast(@as(i64, 0))) else turn_speed(seg.exit_angle))); break :b1 b2: { const near: bool = ((seg.length - state.along) <= approach_intersection_dist()); break :b2 b3: { const a1: f64 = (if (near) corner_brake(state, seg, v_end, a0) else a0); break :b3 b4: { const a3: f64 = pig_gate(state, seg, (if (seg.has_cat) (if ((a1 > @as(f64, @bitCast(@as(i64, 0))))) @as(f64, (if (cat_in_danger((seg.cat.along - state.along), state.v_)) @as(f64, @bitCast(@as(i64, 0))) else a1)) else a1) else a1)); break :b4 b5: { const a4: f64 = shoulder_brake(state, seg, a3); break :b5 (clamp_v(state, seg, v_end, (state.v_ + a4), near) - state.v_); }; }; }; }; }; };
}
...
fn resolve_cross(moved: RiderState, seg: Segment, _arg_segs: *CxList(Segment)) RiderState {
    return b0: { const on_next = rider_state_for_next_segment(moved, _arg_segs); break :b0 (if ((real_abs(on_next.across) < (cx_list_at(_arg_segs, seg.exit_to).width / @as(f64, @bitCast(@as(i64, 4611686018427387904)))))) on_next else moved); };
}

fn get_next_rider_state(state: RiderState, _arg_segs: *CxList(Segment)) RiderState {
    return b0: { const seg = cx_list_at(_arg_segs, state.segment); break :b0 b1: { const dec = decide(state, seg); break :b1 b2: { const moved = simulate_rider_step(state, dec.tilt_step, dec.accel); break :b2 b3: { const resolved = (if (seg.terminates) finish_clamp(moved, seg) else resolve_cross(moved, seg, _arg_segs)); break :b3 next_rider_gaze(resolved, _arg_segs); }; }; }; };
}
...
fn g_rd_seg() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 0, 0, 0, 0, 0, 1, 1, 2, 2, 2, 2, 1, 18, 18, 0 });
}

fn g_rd_along() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4599256083455845335))), @as(f64, @bitCast(@as(i64, 4638243867871606588))), @as(f64, @bitCast(@as(i64, 4638243867871606588))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 4647013158494688478))), @as(f64, @bitCast(@as(i64, 4647459420005842760))), @as(f64, @bitCast(@as(i64, 4633811358971729019))), @as(f64, @bitCast(@as(i64, 4637525421289426125))), @as(f64, @bitCast(@as(i64, 4641296807041661518))), @as(f64, @bitCast(@as(i64, 4644012114514245971))), @as(f64, @bitCast(@as(i64, 4644605198474986484))), @as(f64, @bitCast(@as(i64, 4645045003126096884))), (-@as(f64, @bitCast(@as(i64, 4611658445589029291)))), @as(f64, @bitCast(@as(i64, 4643028031904138081))), @as(f64, @bitCast(@as(i64, 4643985272004935680))), @as(f64, @bitCast(@as(i64, 4641276427197816504))) });
}

fn g_rd_across() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4528553696077051486))), @as(f64, @bitCast(@as(i64, 4606527146405314889))), (-@as(f64, @bitCast(@as(i64, 4606527146405314889)))), @as(f64, @bitCast(@as(i64, 4554737153569043870))), @as(f64, @bitCast(@as(i64, 4591836502509232215))), @as(f64, @bitCast(@as(i64, 4591867876385676329))), @as(f64, @bitCast(@as(i64, 4596362253361585911))), @as(f64, @bitCast(@as(i64, 4596362348837898011))), @as(f64, @bitCast(@as(i64, 4599061258456541228))), @as(f64, @bitCast(@as(i64, 4599326832844263504))), @as(f64, @bitCast(@as(i64, 4599118168283304488))), @as(f64, @bitCast(@as(i64, 4599075584587099878))), @as(f64, @bitCast(@as(i64, 4608725105235094960))), @as(f64, @bitCast(@as(i64, 4591865294562081950))), @as(f64, @bitCast(@as(i64, 4591870164574575003))), @as(f64, @bitCast(@as(i64, 4610781329929922166))) });
}

fn g_rd_yaw() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4540721333009338095))), @as(f64, @bitCast(@as(i64, 4581034187033880605))), (-@as(f64, @bitCast(@as(i64, 4581034187033880605)))), @as(f64, @bitCast(@as(i64, 4553516847584075288))), (-@as(f64, @bitCast(@as(i64, 4556786717254113603)))), (-@as(f64, @bitCast(@as(i64, 4549021108483289481)))), (-@as(f64, @bitCast(@as(i64, 4558016516579218558)))), (-@as(f64, @bitCast(@as(i64, 4558016516579218558)))), (-@as(f64, @bitCast(@as(i64, 4562372736867149355)))), @as(f64, @bitCast(@as(i64, 4575912360631550422))), @as(f64, @bitCast(@as(i64, 4576709195411930417))), (-@as(f64, @bitCast(@as(i64, 4550215868310260146)))), (-@as(f64, @bitCast(@as(i64, 4606035702354977152)))), (-@as(f64, @bitCast(@as(i64, 4550435956413803575)))), (-@as(f64, @bitCast(@as(i64, 4532908893802928697)))), (-@as(f64, @bitCast(@as(i64, 4565689769051059762)))) });
}

fn g_rd_v() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4599256083455845335))), @as(f64, @bitCast(@as(i64, 4609028894647239311))), @as(f64, @bitCast(@as(i64, 4609028894647239311))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 4611945929493542766))), @as(f64, @bitCast(@as(i64, 4602362946422558341))), @as(f64, @bitCast(@as(i64, 4608128174721765212))), @as(f64, @bitCast(@as(i64, 4608083138725491507))), @as(f64, @bitCast(@as(i64, 4609836078411332627))), @as(f64, @bitCast(@as(i64, 4609550782580698110))), @as(f64, @bitCast(@as(i64, 4597769895578813071))), @as(f64, @bitCast(@as(i64, 4597769895578813071))), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4605323332873838867))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607227454796291113))) });
}

fn g_rd_tilt() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4555631258768794298))), (-@as(f64, @bitCast(@as(i64, 4578906459732604752)))), @as(f64, @bitCast(@as(i64, 4578906459732604752))), @as(f64, @bitCast(@as(i64, 4568247952451155358))), (-@as(f64, @bitCast(@as(i64, 4571744455775170496)))), (-@as(f64, @bitCast(@as(i64, 4563754178020847122)))), (-@as(f64, @bitCast(@as(i64, 4572746639134118273)))), (-@as(f64, @bitCast(@as(i64, 4572746639134118273)))), (-@as(f64, @bitCast(@as(i64, 4577066014241312694)))), (-@as(f64, @bitCast(@as(i64, 4580686562753497567)))), (-@as(f64, @bitCast(@as(i64, 4570507778212602776)))), (-@as(f64, @bitCast(@as(i64, 4565247628265729055)))), (-@as(f64, @bitCast(@as(i64, 4553092724748252297)))), (-@as(f64, @bitCast(@as(i64, 4565522738395158340)))), (-@as(f64, @bitCast(@as(i64, 4548117509758935239)))), (-@as(f64, @bitCast(@as(i64, 4580686562753497567)))) });
}

fn g_rd_heading() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4599076622576741995))), @as(f64, @bitCast(@as(i64, 4599051712266483083))), @as(f64, @bitCast(@as(i64, 4599100167035305918))), @as(f64, @bitCast(@as(i64, 4599080706621028079))), @as(f64, @bitCast(@as(i64, 4599067979448481130))), @as(f64, @bitCast(@as(i64, 4599073552202660039))), @as(f64, @bitCast(@as(i64, 4599066413997250656))), @as(f64, @bitCast(@as(i64, 4599066413997250656))), @as(f64, @bitCast(@as(i64, 4599057463183063250))), @as(f64, @bitCast(@as(i64, 4599044506507079290))), @as(f64, @bitCast(@as(i64, 4599069407449850977))), @as(f64, @bitCast(@as(i64, 4599072969256724272))), @as(f64, @bitCast(@as(i64, 4599075502081154705))), @as(f64, @bitCast(@as(i64, 4599072861890909155))), @as(f64, @bitCast(@as(i64, 4599075732305167656))), @as(f64, @bitCast(@as(i64, 4599044506507079290))) });
}

fn g_rd_gazeyaw() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4589694989725525777))), @as(f64, @bitCast(@as(i64, 4589694989725525777))), @as(f64, @bitCast(@as(i64, 4596248015774013971))), @as(f64, @bitCast(@as(i64, 4602615937032345804))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn g_rd_focus() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4592899574318969259))), @as(f64, @bitCast(@as(i64, 4592899574318969259))), @as(f64, @bitCast(@as(i64, 4600877379321698714))), @as(f64, @bitCast(@as(i64, 4606281698874543309))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn g_rd_finished() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false });
}

fn g_rd_turnspeed() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4608519987889346445))), @as(f64, @bitCast(@as(i64, 4605741266919258849))), @as(f64, @bitCast(@as(i64, 4601976257630777115))), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4594176023076171416))), @as(f64, @bitCast(@as(i64, 4593095159165602497))), @as(f64, @bitCast(@as(i64, 4597166413228745425))) });
}

fn g_rd_gawk() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, false, false, false, false, false, false, false, true, true, true, true, false, false, false, false });
}

fn g_rd_pigbrake() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4668012349850910720))), @as(f64, @bitCast(@as(i64, 4668012349850910720))), @as(f64, @bitCast(@as(i64, 4668012349850910720))), @as(f64, @bitCast(@as(i64, 4668012349850910720))), @as(f64, @bitCast(@as(i64, 4668012349850910720))), @as(f64, @bitCast(@as(i64, 4668012349850910720))), @as(f64, @bitCast(@as(i64, 4668012349850910720))), @as(f64, @bitCast(@as(i64, 4668012349850910720))), (-@as(f64, @bitCast(@as(i64, 4577361660785042790)))), (-@as(f64, @bitCast(@as(i64, 4590005160197910157)))), (-@as(f64, @bitCast(@as(i64, 4577638804668006202)))), (-@as(f64, @bitCast(@as(i64, 4577638804668006202)))), @as(f64, @bitCast(@as(i64, 4668012349850910720))), @as(f64, @bitCast(@as(i64, 4668012349850910720))), @as(f64, @bitCast(@as(i64, 4668012349850910720))), @as(f64, @bitCast(@as(i64, 4668012349850910720))) });
}

fn g_rd_gazefocus() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4600012688733675534))), @as(f64, @bitCast(@as(i64, 4606930216680452705))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}
...
fn mk(seg: i64, along: f64, across: f64, yaw: f64, v_: f64, tilt: f64, gy: f64, focus: f64) RiderState {
    return cx_new(RiderStateS{ .segment = seg, .along = along, .across = across, .yaw = yaw, .v_ = v_, .tilt = tilt, .heading = @as(f64, @bitCast(@as(i64, 4599075939470750515))), .gaze_yaw = gy, .focus = focus });
}

fn cases() *CxList(RiderState) {
    return cx_ll_of(RiderState, &[_]RiderState{ mk(0, @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), v_base(), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(0, @as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 4606281698874543309))), @as(f64, @bitCast(@as(i64, 4581421828931458171))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4571261708172110332))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(0, @as(f64, @bitCast(@as(i64, 4638144666238189568))), (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4606281698874543309)))), (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4581421828931458171)))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4571261708172110332)))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(0, @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(0, @as(f64, @bitCast(@as(i64, 4646975943632486400))), @as(f64, @bitCast(@as(i64, 4591870180066957722))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4612136378390124954))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(0, @as(f64, @bitCast(@as(i64, 4647450932655685632))), @as(f64, @bitCast(@as(i64, 4591870180066957722))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4603579539098121011))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(1, @as(f64, @bitCast(@as(i64, 4633641066610819072))), @as(f64, @bitCast(@as(i64, 4596373779694328218))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4608083138725491507))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(1, @as(f64, @bitCast(@as(i64, 4637440978796412928))), @as(f64, @bitCast(@as(i64, 4596373779694328218))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4608083138725491507))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(2, @as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4609884578576439706))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(2, @as(f64, @bitCast(@as(i64, 4643985272004935680))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 4576918229304087675))), @as(f64, @bitCast(@as(i64, 4609884578576439706))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(2, @as(f64, @bitCast(@as(i64, 4644600998516490240))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 4576918229304087675))), @as(f64, @bitCast(@as(i64, 4598175219545276416))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4596373779694328218))), @as(f64, @bitCast(@as(i64, 4600877379321698714)))), mk(2, @as(f64, @bitCast(@as(i64, 4645040803167600640))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4598175219545276416))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4606281698874543309)))), mk(0, @as(f64, @bitCast(@as(i64, 4647486117027774464))), @as(f64, @bitCast(@as(i64, 4587366580439587226))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4597094355634707497))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(18, @as(f64, @bitCast(@as(i64, 4643000109586448384))), @as(f64, @bitCast(@as(i64, 4591870180066957722))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4605380978949069210))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(18, @as(f64, @bitCast(@as(i64, 4643983512786331238))), @as(f64, @bitCast(@as(i64, 4591870180066957722))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4587366580439587226))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), mk(0, @as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 4610785298501913805))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))) });
}
...
fn angles() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4624633867356078080))), @as(f64, @bitCast(@as(i64, 4626322717216342016))), @as(f64, @bitCast(@as(i64, 4629137466983448576))), @as(f64, @bitCast(@as(i64, 4632233691727265792))), @as(f64, @bitCast(@as(i64, 4634626229029306368))), @as(f64, @bitCast(@as(i64, 4635329916471083008))), @as(f64, @bitCast(@as(i64, 4631530004285489152))) });
}
...
fn brake_of(c_: RiderState) *CxList(f64) {
    return b0: { const b_ = pig_gaze_brake(c_, cx_list_at(segs(), c_.segment)); break :b0 (if (b_.engaged) cx_ll_of(f64, &[_]f64{ b_.accel }) else cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4668012349850910720))) })); };
}
...
fn opening() void {
    return b0: { _ = cx_print_line(grade_ints("\x15\x16\x49\x13\x0d\x1d\x02\x02\x02\x02\x02\x02\x02", f_seg(outs(), 0), g_rd_seg())); _ = cx_print_line(grade_px("\x15\x16\x49\x0f\x17\x10\x12\x1d\x02\x02\x02\x02\x02", f_along(outs(), 0), g_rd_along(), @as(f64, @bitCast(@as(i64, 4547007122018943789))), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_px("\x15\x16\x49\x0f\x18\x15\x10\x13\x13\x02\x02\x02\x02", f_across(outs(), 0), g_rd_across(), @as(f64, @bitCast(@as(i64, 4547007122018943789))), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_px("\x15\x16\x49\x1e\x0f\x1b\x02\x02\x02\x02\x02\x02\x02", f_yaw(outs(), 0), g_rd_yaw(), @as(f64, @bitCast(@as(i64, 4502148214488346440))), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_rel("\x15\x16\x49\x21\x02\x02\x02\x02\x02\x02\x02\x02\x02", f_v(outs(), 0), g_rd_v(), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_px("\x15\x16\x49\x0e\x11\x17\x0e\x02\x02\x02\x02\x02\x02", f_tilt(outs(), 0), g_rd_tilt(), @as(f64, @bitCast(@as(i64, 4502148214488346440))), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_rel("\x15\x16\x49\x14\x0d\x0f\x16\x11\x12\x1d\x02\x02\x02", f_heading(outs(), 0), g_rd_heading(), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_px("\x15\x16\x49\x1d\x0f\x26\x0d\x1e\x0f\x1b\x02\x02\x02", f_gazeyaw(outs(), 0), g_rd_gazeyaw(), @as(f64, @bitCast(@as(i64, 4502148214488346440))), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_px("\x15\x16\x49\x1c\x10\x18\x19\x13\x02\x02\x02\x02\x02", f_focus(outs(), 0), g_rd_focus(), @as(f64, @bitCast(@as(i64, 4502148214488346440))), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_bools("\x15\x16\x49\x1c\x11\x12\x11\x13\x14\x0d\x16\x02\x02", finished(cases(), 0), g_rd_finished())); _ = cx_print_line(grade_rel("\x15\x16\x49\x0e\x19\x15\x12\x13\x1f\x0d\x0d\x16\x02", turn_speeds(angles(), 0), g_rd_turnspeed(), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_bools("\x15\x16\x49\x1d\x0f\x1b\x22\x02\x02\x02\x02\x02\x02", gawks(cases(), 0), g_rd_gawk())); _ = cx_print_line(grade_rel("\x15\x16\x49\x1f\x11\x1d\x20\x15\x0f\x22\x0d\x02\x02", pig_brakes(cases(), 0), g_rd_pigbrake(), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_px("\x15\x16\x49\x1d\x0f\x26\x0d\x1c\x10\x18\x19\x13\x02", focuses(cases(), 0), g_rd_gazefocus(), @as(f64, @bitCast(@as(i64, 4502148214488346440))), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); break :b0; };
}

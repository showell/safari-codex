...
fn clip_near(_arg_poly: *CxList(Vec3), _arg_near: f64) *CxList(Vec3) {
    return clip_near_edge(_arg_poly, _arg_near, 0);
}
...
fn gd_right() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4613937818241073152))), (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), @as(f64, @bitCast(@as(i64, 4623226492472524800))) });
}

fn gd_forward() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4630826316843712512))), @as(f64, @bitCast(@as(i64, 4636737291354636288))) });
}

fn gd_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4558165961031657309))), @as(f64, @bitCast(@as(i64, 4575837365393518756))), @as(f64, @bitCast(@as(i64, 4587479170430271488))) });
}
...
fn tr_a() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4622945017495814144))), @as(f64, @bitCast(@as(i64, 4630826316843712512))), @as(f64, @bitCast(@as(i64, 4620130267728707584))) });
}

fn tr_x() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4613937818241073152))), (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), @as(f64, @bitCast(@as(i64, 4618722892845154304))) });
}

fn tr_yaw() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599976659396224614))), (-@as(f64, @bitCast(@as(i64, 4603579539098121011)))), @as(f64, @bitCast(@as(i64, 4608083138725491507))) });
}

fn tr_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4615063718147915776)))), (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), (-@as(f64, @bitCast(@as(i64, 4613645018982491633)))), @as(f64, @bitCast(@as(i64, 4618896461671850156))), @as(f64, @bitCast(@as(i64, 4624759484395331491))), @as(f64, @bitCast(@as(i64, 4629698243985378010))), (-@as(f64, @bitCast(@as(i64, 4608684882191189874)))), @as(f64, @bitCast(@as(i64, 4614993916570415369))) });
}
...
fn lm_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4616189618054758400))) });
}

fn lm_got() *CxList(f64) {
    return b0: { const q = line_meet(cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 0))), .forward = @as(f64, @bitCast(@as(i64, 0))) }), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 0))), .forward = @as(f64, @bitCast(@as(i64, 4607182418800017408))) }), cx_new(RiderPtS{ .right = (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), .forward = @as(f64, @bitCast(@as(i64, 4616189618054758400))) }), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 4613937818241073152))), .forward = @as(f64, @bitCast(@as(i64, 4616189618054758400))) })); break :b0 cx_ll_of(f64, &[_]f64{ q.right, q.forward }); };
}

fn poly() *CxList(Vec3) {
    return cx_ll_of(Vec3, &[_]Vec3{ cx_new(Vec3S{ .right = (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), .forward = @as(f64, @bitCast(@as(i64, 4611686018427387904))), .height = @as(f64, @bitCast(@as(i64, 0))) }), cx_new(Vec3S{ .right = @as(f64, @bitCast(@as(i64, 4607182418800017408))), .forward = @as(f64, @bitCast(@as(i64, 4611686018427387904))), .height = @as(f64, @bitCast(@as(i64, 4602678819172646912))) }), cx_new(Vec3S{ .right = @as(f64, @bitCast(@as(i64, 4607182418800017408))), .forward = (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), .height = @as(f64, @bitCast(@as(i64, 4607182418800017408))) }), cx_new(Vec3S{ .right = (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), .forward = (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), .height = @as(f64, @bitCast(@as(i64, 4609434218613702656))) }) });
}

fn cn_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4600877379321698714))), @as(f64, @bitCast(@as(i64, 4605080738973911176))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), @as(f64, @bitCast(@as(i64, 4600877379321698714))), @as(f64, @bitCast(@as(i64, 4605380978949069210))) });
}
...
fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x1d\x49\x16\x15\x10\x1f\x02", gd_walk(0), gd_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x1d\x49\x15\x11\x16\x0d\x15", tr_walk(0), tr_want(), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_reals("\x1d\x49\x1a\x0d\x0d\x0e\x02", lm_got(), lm_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x1d\x49\x18\x17\x11\x1f\x02", cn_walk(clip_near(poly(), @as(f64, @bitCast(@as(i64, 4600877379321698714)))), 0), cn_want(), @as(f64, @bitCast(@as(i64, 0))))); break :b0; };
}

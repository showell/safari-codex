...
fn pig_ahead(state: RiderState, seg: Segment) PigLook {
    return (if ((seg.pigs_distract == false)) no_look() else (if ((real_abs(state.yaw) > eyes_on_road_yaw())) no_look() else pig_ahead_near(state, seg)));
}
...
fn desired_gaze(state: RiderState, seg: Segment) f64 {
    return @as(f64, (if ((pig_ahead(state, seg).looking == false)) @as(f64, @bitCast(@as(i64, 0))) else desired_gaze_at(state, gaze_pig(seg.length, (seg.width / @as(f64, @bitCast(@as(i64, 4611686018427387904))))))));
}
...
fn next_gaze_yaw(state: RiderState, want: f64) f64 {
    return (if (((want == @as(f64, @bitCast(@as(i64, 0)))) == false)) (state.gaze_yaw + real_max((@as(f64, @bitCast(@as(i64, 0))) - gaze_swivel_rate()), real_min(gaze_swivel_rate(), (want - state.gaze_yaw)))) else @as(f64, (if ((real_abs(state.gaze_yaw) <= gaze_return_snap())) @as(f64, @bitCast(@as(i64, 0))) else (state.gaze_yaw - (r_sign(state.gaze_yaw) * real_min(gaze_return_rate(), (real_abs(state.gaze_yaw) * gaze_return_ease())))))));
}

fn next_focus(state: RiderState, gaze_yaw: f64) f64 {
    return (if ((gaze_yaw == @as(f64, @bitCast(@as(i64, 0))))) real_max(@as(f64, @bitCast(@as(i64, 0))), (state.focus - focus_decay())) else real_max(state.focus, real_min((real_abs(gaze_yaw) / gaze_release_angle()), @as(f64, @bitCast(@as(i64, 4607182418800017408))))));
}
...
fn fixed_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ gaze_look_dist(), focus_decay(), pig_gaze_speed(), pig_gaze_settle_dist(), (gaze_release_angle() / deg()), (gaze_swivel_rate() / deg()), (gaze_return_rate() / deg()), (gaze_return_snap() / deg()), (eyes_on_road_yaw() / deg()), gaze_return_ease() });
}

fn fixed_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4639481672377565184))), @as(f64, @bitCast(@as(i64, 4563176846121054817))), @as(f64, @bitCast(@as(i64, 4596373779694328218))), @as(f64, @bitCast(@as(i64, 4627730092099895296))), @as(f64, @bitCast(@as(i64, 4630122629401935872))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4596373779694328218))), @as(f64, @bitCast(@as(i64, 4581421828931458171))), @as(f64, @bitCast(@as(i64, 4618441417868443648))), @as(f64, @bitCast(@as(i64, 4587366580439587226))) });
}

fn smooth_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ smoothstep(@as(f64, @bitCast(@as(i64, 0)))), smoothstep(@as(f64, @bitCast(@as(i64, 4602678819172646912)))), smoothstep(@as(f64, @bitCast(@as(i64, 4607182418800017408)))), gaze_focus(@as(f64, @bitCast(@as(i64, 4602678819172646912)))) });
}

fn smooth_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4602678819172646912))) });
}
...
fn distracting() Segment {
    return segment_at(2);
}

fn rider(along: f64, yaw: f64) RiderState {
    return cx_new(RiderStateS{ .segment = 2, .along = along, .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = yaw, .v_ = v_base(), .tilt = @as(f64, @bitCast(@as(i64, 0))), .heading = @as(f64, @bitCast(@as(i64, 0))), .gaze_yaw = @as(f64, @bitCast(@as(i64, 0))), .focus = @as(f64, @bitCast(@as(i64, 0))) });
}

fn legs_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ plain().pigs_distract, distracting().pigs_distract });
}

fn legs_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, true });
}

fn looking_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ pig_ahead(rider(@as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 0)))), plain()).looking, pig_ahead(rider(@as(f64, @bitCast(@as(i64, 4641240890982006784))), (@as(f64, @bitCast(@as(i64, 4621819117588971520))) * deg())), distracting()).looking, pig_ahead(rider(@as(f64, @bitCast(@as(i64, 4636737291354636288))), @as(f64, @bitCast(@as(i64, 0)))), distracting()).looking, pig_ahead(rider(@as(f64, @bitCast(@as(i64, 4644706551632756736))), @as(f64, @bitCast(@as(i64, 0)))), distracting()).looking, pig_ahead(rider(@as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 0)))), distracting()).looking, no_look().looking });
}

fn looking_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, false, false, false, true, false });
}

fn dist_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ pig_ahead(rider(@as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 0)))), distracting()).dist, pig_ahead(rider(@as(f64, @bitCast(@as(i64, 4636737291354636288))), @as(f64, @bitCast(@as(i64, 0)))), distracting()).dist, no_look().dist });
}

fn dist_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4639200197400854528))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn want_got() *CxList(bool) {
    return b0: { const far: f64 = desired_gaze(rider(@as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 0)))), distracting()); break :b0 b1: { const near_1: f64 = desired_gaze(rider(@as(f64, @bitCast(@as(i64, 4644337115725824000))), @as(f64, @bitCast(@as(i64, 0)))), distracting()); break :b1 cx_ll_of(bool, &[_]bool{ (far > @as(f64, @bitCast(@as(i64, 0)))), (near_1 > far), (desired_gaze(rider(@as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 0)))), plain()) == @as(f64, @bitCast(@as(i64, 0)))) }); }; };
}

fn want_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true });
}

fn head(gaze_yaw: f64, along: f64) RiderState {
    return cx_new(RiderStateS{ .segment = 2, .along = along, .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .v_ = v_base(), .tilt = @as(f64, @bitCast(@as(i64, 0))), .heading = @as(f64, @bitCast(@as(i64, 0))), .gaze_yaw = gaze_yaw, .focus = @as(f64, @bitCast(@as(i64, 0))) });
}

fn swivel_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (next_gaze_yaw(head(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4641240890982006784)))), @as(f64, @bitCast(@as(i64, 4607182418800017408)))) - gaze_swivel_rate()), (next_gaze_yaw(head(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4641240890982006784)))), (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4607182418800017408))))) + gaze_swivel_rate()), (next_gaze_yaw(head(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4641240890982006784)))), (gaze_swivel_rate() / @as(f64, @bitCast(@as(i64, 4611686018427387904))))) - (gaze_swivel_rate() / @as(f64, @bitCast(@as(i64, 4611686018427387904))))) });
}

fn swivel_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn return_got() *CxList(bool) {
    return b0: { const big: f64 = next_gaze_yaw(head((@as(f64, @bitCast(@as(i64, 4629137466983448576))) * deg()), @as(f64, @bitCast(@as(i64, 4641240890982006784)))), @as(f64, @bitCast(@as(i64, 0)))); break :b0 b1: { const small: f64 = next_gaze_yaw(head((@as(f64, @bitCast(@as(i64, 4611686018427387904))) * deg()), @as(f64, @bitCast(@as(i64, 4641240890982006784)))), @as(f64, @bitCast(@as(i64, 0)))); break :b1 cx_ll_of(bool, &[_]bool{ (big < (@as(f64, @bitCast(@as(i64, 4629137466983448576))) * deg())), (big > @as(f64, @bitCast(@as(i64, 0)))), (small < (@as(f64, @bitCast(@as(i64, 4611686018427387904))) * deg())), (small > @as(f64, @bitCast(@as(i64, 0)))), (((@as(f64, @bitCast(@as(i64, 4629137466983448576))) * deg()) - big) > ((@as(f64, @bitCast(@as(i64, 4611686018427387904))) * deg()) - small)) }); }; };
}

fn return_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true, true, true });
}

fn snap_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ next_gaze_yaw(head(gaze_return_snap(), @as(f64, @bitCast(@as(i64, 4641240890982006784)))), @as(f64, @bitCast(@as(i64, 0)))), next_gaze_yaw(head((@as(f64, @bitCast(@as(i64, 0))) - gaze_return_snap()), @as(f64, @bitCast(@as(i64, 4641240890982006784)))), @as(f64, @bitCast(@as(i64, 0)))), next_gaze_yaw(head(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4641240890982006784)))), @as(f64, @bitCast(@as(i64, 0)))) });
}

fn snap_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn focused(focus: f64, gaze_yaw: f64) RiderState {
    return cx_new(RiderStateS{ .segment = 2, .along = @as(f64, @bitCast(@as(i64, 4641240890982006784))), .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .v_ = v_base(), .tilt = @as(f64, @bitCast(@as(i64, 0))), .heading = @as(f64, @bitCast(@as(i64, 0))), .gaze_yaw = gaze_yaw, .focus = focus });
}

fn focus_got() *CxList(bool) {
    return b0: { const rising: f64 = next_focus(focused(@as(f64, @bitCast(@as(i64, 0))), (@as(f64, @bitCast(@as(i64, 4626322717216342016))) * deg())), (@as(f64, @bitCast(@as(i64, 4626322717216342016))) * deg())); break :b0 b1: { const held: f64 = next_focus(focused(@as(f64, @bitCast(@as(i64, 4606281698874543309))), (@as(f64, @bitCast(@as(i64, 4607182418800017408))) * deg())), (@as(f64, @bitCast(@as(i64, 4607182418800017408))) * deg())); break :b1 b2: { const easing: f64 = next_focus(focused(@as(f64, @bitCast(@as(i64, 4606281698874543309))), @as(f64, @bitCast(@as(i64, 0)))), @as(f64, @bitCast(@as(i64, 0)))); break :b2 cx_ll_of(bool, &[_]bool{ (rising > @as(f64, @bitCast(@as(i64, 0)))), (held >= @as(f64, @bitCast(@as(i64, 4606281698874543309)))), (easing < @as(f64, @bitCast(@as(i64, 4606281698874543309)))), (easing > @as(f64, @bitCast(@as(i64, 0)))) }); }; }; };
}

fn focus_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true, true });
}

fn focus_ends_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ next_focus(focused(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), @as(f64, @bitCast(@as(i64, 0)))), next_focus(focused(@as(f64, @bitCast(@as(i64, 0))), (@as(f64, @bitCast(@as(i64, 4636033603912859648))) * deg())), (@as(f64, @bitCast(@as(i64, 4636033603912859648))) * deg())) });
}

fn focus_ends_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))) });
}

fn gawk_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ gawk_engaged(rider(@as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 0)))), plain()), gawk_engaged(rider(@as(f64, @bitCast(@as(i64, 4636737291354636288))), @as(f64, @bitCast(@as(i64, 0)))), distracting()), gawk_engaged(rider(@as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 0)))), distracting()), gawk_engaged(rider(@as(f64, @bitCast(@as(i64, 4644706551632756736))), @as(f64, @bitCast(@as(i64, 0)))), distracting()) });
}

fn gawk_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, false, true, true });
}

fn outlast_got() *CxList(bool) {
    return b0: { const looks: bool = pig_ahead(rider(@as(f64, @bitCast(@as(i64, 4644706551632756736))), @as(f64, @bitCast(@as(i64, 0)))), distracting()).looking; break :b0 cx_ll_of(bool, &[_]bool{ (looks == false), gawk_engaged(rider(@as(f64, @bitCast(@as(i64, 4644706551632756736))), @as(f64, @bitCast(@as(i64, 0)))), distracting()) }); };
}

fn outlast_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x1d\x26\x49\x1c\x11\x24\x0d\x16\x02", fixed_got(), fixed_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_reals("\x1d\x26\x49\x13\x1a\x10\x10\x0e\x14", smooth_got(), smooth_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x1d\x26\x49\x17\x0d\x1d\x13\x02\x02", legs_got(), legs_want())); _ = cx_print_line(grade_bools("\x1d\x26\x49\x17\x10\x10\x22\x02\x02", looking_got(), looking_want())); _ = cx_print_line(grade_reals("\x1d\x26\x49\x16\x11\x13\x0e\x02\x02", dist_got(), dist_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x1d\x26\x49\x1b\x0f\x12\x0e\x02\x02", want_got(), want_want())); _ = cx_print_line(grade_reals("\x1d\x26\x49\x13\x1b\x11\x21\x0d\x17", swivel_got(), swivel_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x1d\x26\x49\x15\x0d\x0e\x19\x15\x12", return_got(), return_want())); _ = cx_print_line(grade_reals("\x1d\x26\x49\x13\x12\x0f\x1f\x02\x02", snap_got(), snap_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x1d\x26\x49\x1c\x10\x18\x19\x13\x02", focus_got(), focus_want())); _ = cx_print_line(grade_reals("\x1d\x26\x49\x1c\x0d\x12\x16\x13\x02", focus_ends_got(), focus_ends_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x1d\x26\x49\x1d\x0f\x1b\x22\x02\x02", gawk_got(), gawk_want())); _ = cx_print_line(grade_bools("\x1d\x26\x49\x10\x19\x0e\x17\x13\x0e", outlast_got(), outlast_want())); break :b0; };
}

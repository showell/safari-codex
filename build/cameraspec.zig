...
fn at(right: f64, forward: f64, height: f64) ScreenPt {
    return project(cx_new(Vec3S{ .right = right, .forward = forward, .height = height }), @as(f64, @bitCast(@as(i64, 4650248090236747776))), @as(f64, @bitCast(@as(i64, 4651655465120301056))));
}

fn x_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ at(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4608083138725491507)))).x, at(@as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4608083138725491507)))).x, at((@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4617315517961601024)))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4608083138725491507)))).x, at(@as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4617315517961601024))), @as(f64, @bitCast(@as(i64, 4608083138725491507)))).x });
}

fn x_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647151865492930560))), @as(f64, @bitCast(@as(i64, 4653344314980564992))), @as(f64, @bitCast(@as(i64, 4635329916471083008))), @as(f64, @bitCast(@as(i64, 4656792383445270528))) });
}

fn y_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ at(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4608083138725491507)))).y, at(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4622494657533077094)))).y, at(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4618666597849812173)))).y, at(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4596373779694328218)))).y, at(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4614388178203810202)))).y });
}

fn y_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4643985272004935680))), (-@as(f64, @bitCast(@as(i64, 4647503709213818880)))), (-@as(f64, @bitCast(@as(i64, 4636737291354636288)))), @as(f64, @bitCast(@as(i64, 4645392646888488960))), (-@as(f64, @bitCast(@as(i64, 4636737291354636288)))) });
}

fn depth_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ at(@as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4608083138725491507)))).x, at(@as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4620693217682128896))), @as(f64, @bitCast(@as(i64, 4608083138725491507)))).x, at(@as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4625196817309499392))), @as(f64, @bitCast(@as(i64, 4608083138725491507)))).x, at(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4617540697942969549)))).y, at(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4620693217682128896))), @as(f64, @bitCast(@as(i64, 4617540697942969549)))).y, at(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4625196817309499392))), @as(f64, @bitCast(@as(i64, 4617540697942969549)))).y });
}

fn depth_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4653344314980564992))), @as(f64, @bitCast(@as(i64, 4650951777678524416))), @as(f64, @bitCast(@as(i64, 4649192559074082816))), (-@as(f64, @bitCast(@as(i64, 4647503709213818880)))), (-@as(f64, @bitCast(@as(i64, 4636737291354636288)))), @as(f64, @bitCast(@as(i64, 4636737291354636288))) });
}

fn fixed_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ camera_h(), eye_h() });
}

fn fixed_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4648488871632306176))), @as(f64, @bitCast(@as(i64, 4608083138725491507))) });
}

fn three() *CxList(Vec3) {
    return cx_ll_of(Vec3, &[_]Vec3{ cx_new(Vec3S{ .right = @as(f64, @bitCast(@as(i64, 0))), .forward = @as(f64, @bitCast(@as(i64, 4621819117588971520))), .height = @as(f64, @bitCast(@as(i64, 4608083138725491507))) }), cx_new(Vec3S{ .right = @as(f64, @bitCast(@as(i64, 4621819117588971520))), .forward = @as(f64, @bitCast(@as(i64, 4621819117588971520))), .height = @as(f64, @bitCast(@as(i64, 4608083138725491507))) }), cx_new(Vec3S{ .right = @as(f64, @bitCast(@as(i64, 0))), .forward = @as(f64, @bitCast(@as(i64, 4621819117588971520))), .height = @as(f64, @bitCast(@as(i64, 4622494657533077094))) }) });
}

fn all_got() *CxList(f64) {
    return b0: { const sp = project_all(three(), @as(f64, @bitCast(@as(i64, 4650248090236747776))), @as(f64, @bitCast(@as(i64, 4651655465120301056))), 0); break :b0 cx_ll_of(f64, &[_]f64{ cx_real_from_int(cx_list_len(sp)), cx_list_at(sp, 0).x, cx_list_at(sp, 1).x, cx_list_at(sp, 2).y, cx_real_from_int(cx_list_len(project_all(cx_ll_empty(Vec3), @as(f64, @bitCast(@as(i64, 4650248090236747776))), @as(f64, @bitCast(@as(i64, 4651655465120301056))), 0))) }); };
}

fn all_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4613937818241073152))), @as(f64, @bitCast(@as(i64, 4647151865492930560))), @as(f64, @bitCast(@as(i64, 4653344314980564992))), (-@as(f64, @bitCast(@as(i64, 4647503709213818880)))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x18\x1a\x49\x24\x02\x02\x02\x02", x_got(), x_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x18\x1a\x49\x1e\x02\x02\x02\x02", y_got(), y_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x18\x1a\x49\x16\x0d\x1f\x0e\x14", depth_got(), depth_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x18\x1a\x49\x1c\x11\x24\x0d\x16", fixed_got(), fixed_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x18\x1a\x49\x0f\x17\x17\x02\x02", all_got(), all_want(), @as(f64, @bitCast(@as(i64, 0))))); break :b0; };
}

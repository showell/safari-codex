...
fn pow2_int(k_: i64) f64 {
    return (if ((k_ >= 0)) pow2_up(k_, @as(f64, @bitCast(@as(i64, 4607182418800017408)))) else pow2_down(k_, @as(f64, @bitCast(@as(i64, 4607182418800017408)))));
}

fn exp_real(x: f64) f64 {
    return b0: { const k_: i64 = cx_real_to_int(round_real((x / ln2()))); break :b0 (exp_poly((x - (cx_real_from_int(k_) * ln2()))) * pow2_int(k_)); };
}
...
fn round_in() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4643193623632936960)))), (-@as(f64, @bitCast(@as(i64, 4638725208377655296)))), (-@as(f64, @bitCast(@as(i64, 4636033603912859648)))), (-@as(f64, @bitCast(@as(i64, 4635358063968754074)))), (-@as(f64, @bitCast(@as(i64, 4634661413401395200)))), (-@as(f64, @bitCast(@as(i64, 4612811918334230528)))), (-@as(f64, @bitCast(@as(i64, 4609434218613702656)))), (-@as(f64, @bitCast(@as(i64, 4602678819172646913)))), (-@as(f64, @bitCast(@as(i64, 4602678819172646912)))), (-@as(f64, @bitCast(@as(i64, 4602678819172646911)))), (-@as(f64, @bitCast(@as(i64, 4598175219545276416)))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4598175219545276416))), @as(f64, @bitCast(@as(i64, 4602678819172646911))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4609434218613702656))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 4616752568008179712))), @as(f64, @bitCast(@as(i64, 4624352392379367424))), @as(f64, @bitCast(@as(i64, 4626181979727986688))), @as(f64, @bitCast(@as(i64, 4628996729495093248))), @as(f64, @bitCast(@as(i64, 4632163322983088128))), @as(f64, @bitCast(@as(i64, 4634661413401395200))), @as(f64, @bitCast(@as(i64, 4638672431819522048))), @as(f64, @bitCast(@as(i64, 4638725208377655296))), @as(f64, @bitCast(@as(i64, 4643158439260848128))), @as(f64, @bitCast(@as(i64, 4643176031446892544))), @as(f64, @bitCast(@as(i64, 4697254413494910976))) });
}

fn round_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4643211215818981376)))), (-@as(f64, @bitCast(@as(i64, 4638742800563699712)))), (-@as(f64, @bitCast(@as(i64, 4636033603912859648)))), (-@as(f64, @bitCast(@as(i64, 4635329916471083008)))), (-@as(f64, @bitCast(@as(i64, 4634696597773484032)))), (-@as(f64, @bitCast(@as(i64, 4613937818241073152)))), (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), (-@as(f64, @bitCast(@as(i64, 0)))), (-@as(f64, @bitCast(@as(i64, 0)))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4613937818241073152))), @as(f64, @bitCast(@as(i64, 4617315517961601024))), @as(f64, @bitCast(@as(i64, 4624633867356078080))), @as(f64, @bitCast(@as(i64, 4626322717216342016))), @as(f64, @bitCast(@as(i64, 4629137466983448576))), @as(f64, @bitCast(@as(i64, 4632233691727265792))), @as(f64, @bitCast(@as(i64, 4634696597773484032))), @as(f64, @bitCast(@as(i64, 4638707616191610880))), @as(f64, @bitCast(@as(i64, 4638742800563699712))), @as(f64, @bitCast(@as(i64, 4643176031446892544))), @as(f64, @bitCast(@as(i64, 4643176031446892544))), @as(f64, @bitCast(@as(i64, 4697254415642394624))) });
}

fn floor_in() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4652011706887700480)))), (-@as(f64, @bitCast(@as(i64, 4638144666238189568)))), (-@as(f64, @bitCast(@as(i64, 4638109481866100736)))), (-@as(f64, @bitCast(@as(i64, 4612811918334230528)))), (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), (-@as(f64, @bitCast(@as(i64, 4609434218613702656)))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), (-@as(f64, @bitCast(@as(i64, 4602678819172646912)))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4609434218613702656))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 4638109481866100736))), @as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 4652011706887700480))) });
}

fn floor_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4652016104934211584)))), (-@as(f64, @bitCast(@as(i64, 4638144666238189568)))), (-@as(f64, @bitCast(@as(i64, 4638144666238189568)))), (-@as(f64, @bitCast(@as(i64, 4613937818241073152)))), (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4638074297494011904))), @as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 4652007308841189376))) });
}

fn ceil_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4652007308841189376)))), (-@as(f64, @bitCast(@as(i64, 4638144666238189568)))), (-@as(f64, @bitCast(@as(i64, 4638074297494011904)))), (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4613937818241073152))), @as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 4652016104934211584))) });
}

fn mod_x() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4652007308841189376)))), (-@as(f64, @bitCast(@as(i64, 4642648265865560064)))), (-@as(f64, @bitCast(@as(i64, 4642630673679515648)))), (-@as(f64, @bitCast(@as(i64, 4638144666238189568)))), (-@as(f64, @bitCast(@as(i64, 4638109481866100736)))), (-@as(f64, @bitCast(@as(i64, 4602678819172646912)))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4638109481866100736))), @as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 4642665858051604480))), @as(f64, @bitCast(@as(i64, 4652007308841189376))), @as(f64, @bitCast(@as(i64, 4660135448549523456))) });
}

fn mod_m() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4638144666238189568))), @as(f64, @bitCast(@as(i64, 4620130267728707584))), (-@as(f64, @bitCast(@as(i64, 4638144666238189568)))) });
}

fn mod_want() *CxList(f64) {
    @setEvalBranchQuota(1000000);
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4635329916471083008))), (-@as(f64, @bitCast(@as(i64, 0)))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), (-@as(f64, @bitCast(@as(i64, 0)))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4638109481866100736))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4638109481866100736))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4630826316843712512))), @as(f64, @bitCast(@as(i64, 4598175219545276416))), @as(f64, @bitCast(@as(i64, 4617315517961601024))), (-@as(f64, @bitCast(@as(i64, 0)))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), (-@as(f64, @bitCast(@as(i64, 0)))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4619567317775286272))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4619567317775286272))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 4598175219545276416))), (-@as(f64, @bitCast(@as(i64, 4630826316843712512)))), (-@as(f64, @bitCast(@as(i64, 0)))), (-@as(f64, @bitCast(@as(i64, 4638109481866100736)))), (-@as(f64, @bitCast(@as(i64, 0)))), (-@as(f64, @bitCast(@as(i64, 4638109481866100736)))), (-@as(f64, @bitCast(@as(i64, 4602678819172646912)))), @as(f64, @bitCast(@as(i64, 0))), (-@as(f64, @bitCast(@as(i64, 4638109481866100736)))), (-@as(f64, @bitCast(@as(i64, 4602678819172646912)))), @as(f64, @bitCast(@as(i64, 0))), (-@as(f64, @bitCast(@as(i64, 4638109481866100736)))), (-@as(f64, @bitCast(@as(i64, 4635329916471083008)))), (-@as(f64, @bitCast(@as(i64, 4638127074052145152)))) });
}
...
fn mod_outer(ms: *CxList(f64), xs: *CxList(f64), i_: i64) *CxList(f64) {
    return (if ((i_ >= cx_list_len(ms))) cx_ll_empty(f64) else cx_ll_concat(mod_inner(cx_list_at(ms, i_), xs, 0), mod_outer(ms, xs, (i_ + 1))));
}

fn pow2_k() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ -55, -20, -8, -1, 0, 1, 8, 20, 55 });
}

fn pow2_want() *CxList(f64) {
...
fn exp_in() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4636737291354636288)))), (-@as(f64, @bitCast(@as(i64, 4632233691727265792)))), (-@as(f64, @bitCast(@as(i64, 4626322717216342016)))), (-@as(f64, @bitCast(@as(i64, 4617315517961601024)))), (-@as(f64, @bitCast(@as(i64, 4612811918334230528)))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), (-@as(f64, @bitCast(@as(i64, 4604418534313441775)))), (-@as(f64, @bitCast(@as(i64, 4599914934686071280)))), (-@as(f64, @bitCast(@as(i64, 4599914934686071279)))), (-@as(f64, @bitCast(@as(i64, 4587366580439587226)))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4587366580439587226))), @as(f64, @bitCast(@as(i64, 4599914934686071280))), @as(f64, @bitCast(@as(i64, 4604418534313441775))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 4617315517961601024))), @as(f64, @bitCast(@as(i64, 4626322717216342016))) });
}

fn exp_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 3957129287720677212))), @as(f64, @bitCast(@as(i64, 4282120040917895232))), @as(f64, @bitCast(@as(i64, 4477057993643618919))), @as(f64, @bitCast(@as(i64, 4574418346145829750))), @as(f64, @bitCast(@as(i64, 4590579268170609701))), @as(f64, @bitCast(@as(i64, 4600298746774613816))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4604544271217802188))), @as(f64, @bitCast(@as(i64, 4604544271217802188))), @as(f64, @bitCast(@as(i64, 4606743132508726950))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4607413323290551346))), @as(f64, @bitCast(@as(i64, 4609047870845172685))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4613303445314885482))), @as(f64, @bitCast(@as(i64, 4623047752462491834))), @as(f64, @bitCast(@as(i64, 4639425840376984463))), @as(f64, @bitCast(@as(i64, 4736919330018093060))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x12\x49\x15\x10\x19\x12\x16", list_map(f64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, _cp0: f64) f64 { _ = _ctx4; return round_real(_cp0); } }; break :b4 CxFn1(f64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, round_in()), round_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x12\x49\x1c\x17\x10\x10\x15", list_map(f64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, _cp0: f64) f64 { _ = _ctx4; return floor_real(_cp0); } }; break :b4 CxFn1(f64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, floor_in()), floor_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x12\x49\x18\x0d\x11\x17\x02", list_map(f64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, _cp0: f64) f64 { _ = _ctx4; return ceil_real(_cp0); } }; break :b4 CxFn1(f64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, floor_in()), ceil_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x12\x49\x1a\x10\x16\x02\x02", mod_outer(mod_m(), mod_x(), 0), mod_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x12\x49\x1f\x10\x1b\x05\x02", list_map(i64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, _cp0: i64) f64 { _ = _ctx4; return pow2_int(_cp0); } }; break :b4 CxFn1(i64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, pow2_k()), pow2_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_rel("\x12\x49\x0d\x24\x1f\x02\x02", list_map(f64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, _cp0: f64) f64 { _ = _ctx4; return exp_real(_cp0); } }; break :b4 CxFn1(f64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, exp_in()), exp_want(), @as(f64, @bitCast(@as(i64, 4382569440205035030))))); break :b0; };
}

...
*The dated work journal that used to follow -- the shake_parts snag, the
build-path lesson, and the 2026-08-30 entries -- is in git. What stands is
above: which trees, why this base, where things run, what the change is, and
what verified it.*

...
fn max_radius(_arg_sp: *CxList(ScreenPt), c_: ScreenPt, i_: i64) f64 {
    return @as(f64, (if ((i_ >= cx_list_len(_arg_sp))) @as(f64, @bitCast(@as(i64, 0))) else real_max(pt_dist(cx_list_at(_arg_sp, i_), c_), max_radius(_arg_sp, c_, (i_ +% 1)))));
}
...
fn box_at(c_: f64, hw: f64) *CxList(f64) {
    return b0: { const b_ = truck_box(c_, hw); break :b0 cx_ll_of(f64, &[_]f64{ b_.a0, b_.a1, b_.a2, b_.a_roof, b_.xl, b_.xr }); };
}

fn box_got() *CxList(f64) {
    return cx_ll_concat(box_at(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), box_at(@as(f64, @bitCast(@as(i64, 4630826316843712512))), @as(f64, @bitCast(@as(i64, 4611686018427387904)))));
}

fn box_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4616414798036126925)))), @as(f64, @bitCast(@as(i64, 4616414798036126925))), @as(f64, @bitCast(@as(i64, 4620355447710076109))), @as(f64, @bitCast(@as(i64, 4617596992938311680))), (-@as(f64, @bitCast(@as(i64, 4608083138725491507)))), @as(f64, @bitCast(@as(i64, 4608083138725491507))), @as(f64, @bitCast(@as(i64, 4630235219392620134))), @as(f64, @bitCast(@as(i64, 4631417414294804890))), @as(f64, @bitCast(@as(i64, 4631909995504048538))), @as(f64, @bitCast(@as(i64, 4631565188657577984))), @as(f64, @bitCast(@as(i64, 4605380978949069210))), @as(f64, @bitCast(@as(i64, 4614388178203810202))) });
}

fn bottom_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ tire_radius(), trailer_bottom(), cab_bottom(), truck_height(), truck_width(), truck_length() });
}

fn bottom_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4607722850755301868))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4615288898129284301))), @as(f64, @bitCast(@as(i64, 4612586738352862003))), @as(f64, @bitCast(@as(i64, 4620918397663497421))) });
}

fn axles_got() *CxList(f64) {
    return cx_ll_concat(truck_axles(truck_box(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))))), truck_axles(truck_box(@as(f64, @bitCast(@as(i64, 4630826316843712512))), @as(f64, @bitCast(@as(i64, 4611686018427387904))))));
}

fn axles_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4614388178203810202)))), (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4614388178203810202))), @as(f64, @bitCast(@as(i64, 4618582155356798976))), @as(f64, @bitCast(@as(i64, 4630375956880975462))), @as(f64, @bitCast(@as(i64, 4630544841867001856))), @as(f64, @bitCast(@as(i64, 4631107791820423168))), @as(f64, @bitCast(@as(i64, 4631276676806449562))), @as(f64, @bitCast(@as(i64, 4631688333959888896))) });
}

fn axle_count_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(truck_axles(truck_box(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))))) });
}

fn axle_count_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 5 });
}

fn v3(f: f64) Vec3 {
    return cx_new(Vec3S{ .right = @as(f64, @bitCast(@as(i64, 0))), .forward = f, .height = @as(f64, @bitCast(@as(i64, 0))) });
}

fn quad_face() TruckFace {
    return truck_face(1846886, cx_ll_of(Vec3, &[_]Vec3{ v3(@as(f64, @bitCast(@as(i64, 4621819117588971520)))), v3(@as(f64, @bitCast(@as(i64, 4626322717216342016)))), v3(@as(f64, @bitCast(@as(i64, 4629137466983448576)))), v3(@as(f64, @bitCast(@as(i64, 4630826316843712512)))) }));
}

fn tri_face() TruckFace {
    return truck_face(1381658, cx_ll_of(Vec3, &[_]Vec3{ v3(@as(f64, @bitCast(@as(i64, 4607182418800017408)))), v3(@as(f64, @bitCast(@as(i64, 4611686018427387904)))), v3(@as(f64, @bitCast(@as(i64, 4618441417868443648)))) }));
}

fn face_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ quad_face().fwd, tri_face().fwd });
}

fn face_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4627730092099895296))), @as(f64, @bitCast(@as(i64, 4613937818241073152))) });
}

fn face_carry_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ quad_face().color, cx_list_len(quad_face().v_), tri_face().color, cx_list_len(tri_face().v_) });
}

fn face_carry_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1846886, 4, 1381658, 3 });
}

fn mark(c_: i64, f: f64) TruckFace {
    return cx_new(TruckFaceS{ .color = c_, .fwd = f, .v_ = cx_ll_empty(Vec3) });
}

fn colours_of(fs: *CxList(TruckFace), i_: i64) *CxList(i64) {
    return (if ((i_ >= cx_list_len(fs))) cx_ll_empty(i64) else cx_ll_concat(cx_ll_of(i64, &[_]i64{ cx_list_at(fs, i_).color }), colours_of(fs, (i_ +% 1))));
}

fn tied() *CxList(TruckFace) {
    return cx_ll_of(TruckFace, &[_]TruckFace{ mark(1, @as(f64, @bitCast(@as(i64, 4629137466983448576)))), mark(2, @as(f64, @bitCast(@as(i64, 4621819117588971520)))), mark(3, @as(f64, @bitCast(@as(i64, 4629137466983448576)))), mark(4, @as(f64, @bitCast(@as(i64, 4626322717216342016)))), mark(5, @as(f64, @bitCast(@as(i64, 4629137466983448576)))) });
}

fn tied_got() *CxList(i64) {
    return colours_of(sort_faces(tied()), 0);
}

fn tied_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1, 3, 5, 4, 2 });
}

fn slack() *CxList(TruckFace) {
    return cx_ll_of(TruckFace, &[_]TruckFace{ mark(1, @as(f64, @bitCast(@as(i64, 4626322717216342016)))), mark(2, @as(f64, @bitCast(@as(i64, 4626322717497816993)))), mark(3, @as(f64, @bitCast(@as(i64, 4626325531966109123)))), mark(4, @as(f64, @bitCast(@as(i64, 4626041242239631360)))) });
}

fn slack_got() *CxList(i64) {
    return colours_of(sort_faces(slack()), 0);
}

fn slack_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 3, 1, 2, 4 });
}

fn small_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(sort_faces(cx_ll_empty(TruckFace))), cx_list_len(sort_faces(cx_ll_of(TruckFace, &[_]TruckFace{ mark(7, @as(f64, @bitCast(@as(i64, 4607182418800017408)))) }))), cx_list_at(sort_faces(cx_ll_of(TruckFace, &[_]TruckFace{ mark(7, @as(f64, @bitCast(@as(i64, 4607182418800017408)))) })), 0).color });
}

fn small_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 1, 7 });
}
...
fn panel() *CxList(ScreenPt) {
    return cx_ll_of(ScreenPt, &[_]ScreenPt{ sp(@as(f64, @bitCast(@as(i64, 4613937818241073152))), @as(f64, @bitCast(@as(i64, 4616189618054758400)))), sp(@as(f64, @bitCast(@as(i64, 4618441417868443648))), @as(f64, @bitCast(@as(i64, 4620693217682128896)))), sp(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), sp(@as(f64, @bitCast(@as(i64, 4619567317775286272))), @as(f64, @bitCast(@as(i64, 4616189618054758400)))) });
}

fn halo_got() *CxList(f64) {
    return b0: { const cx: f64 = (sum_x(panel(), 0) / @as(f64, @bitCast(@as(i64, 4616189618054758400)))); break :b0 b1: { const cy: f64 = (sum_y(panel(), 0) / @as(f64, @bitCast(@as(i64, 4616189618054758400)))); break :b1 cx_ll_of(f64, &[_]f64{ sum_x(panel(), 0), sum_y(panel(), 0), cx, cy, pt_dist(sp(@as(f64, @bitCast(@as(i64, 4613937818241073152))), @as(f64, @bitCast(@as(i64, 4616189618054758400)))), sp(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))))), max_radius(panel(), sp(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), 0), (max_radius(panel(), sp(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0)))), 0) * @as(f64, @bitCast(@as(i64, 4614388178203810202)))) }); }; };
}

fn halo_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4625196817309499392))), @as(f64, @bitCast(@as(i64, 4625196817309499392))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4617315517961601024))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4629700416936869888))) });
}

fn circle_count_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(glow_circle(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), 0)), glow_sides(), tire_sides() });
}

fn circle_count_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 16, 16, 16 });
}

fn behind_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ any_behind(cx_ll_of(Vec3, &[_]Vec3{ v3(@as(f64, @bitCast(@as(i64, 4621819117588971520)))), v3(@as(f64, @bitCast(@as(i64, 4626322717216342016)))), v3(@as(f64, @bitCast(@as(i64, 4629137466983448576)))) }), 0), any_behind(cx_ll_of(Vec3, &[_]Vec3{ v3(@as(f64, @bitCast(@as(i64, 4621819117588971520)))), v3(@as(f64, @bitCast(@as(i64, 4596373779694328218)))), v3(@as(f64, @bitCast(@as(i64, 4629137466983448576)))) }), 0), any_behind(cx_ll_of(Vec3, &[_]Vec3{ v3(@as(f64, @bitCast(@as(i64, 4621819117588971520)))), v3(@as(f64, @bitCast(@as(i64, 4600877379321698714)))), v3(@as(f64, @bitCast(@as(i64, 4629137466983448576)))) }), 0), any_behind(cx_ll_of(Vec3, &[_]Vec3{ v3(@as(f64, @bitCast(@as(i64, 4601057523306793533)))) }), 0), any_behind(cx_ll_empty(Vec3), 0) });
}

fn behind_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, true, true, false, false });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x0e\x16\x49\x20\x10\x24\x02\x02\x02", box_got(), box_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0e\x16\x49\x20\x10\x0e\x0e\x10\x1a", bottom_got(), bottom_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0e\x16\x49\x0f\x24\x17\x0d\x13\x02", axles_got(), axles_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x0e\x16\x49\x12\x0f\x24\x17\x0d\x02", axle_count_got(), axle_count_want())); _ = cx_print_line(grade_reals("\x0e\x16\x49\x1c\x0f\x18\x0d\x02\x02", face_got(), face_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x0e\x16\x49\x18\x0f\x15\x15\x1e\x02", face_carry_got(), face_carry_want())); _ = cx_print_line(grade_ints("\x0e\x16\x49\x0e\x11\x0d\x16\x02\x02", tied_got(), tied_want())); _ = cx_print_line(grade_ints("\x0e\x16\x49\x13\x17\x0f\x18\x22\x02", slack_got(), slack_want())); _ = cx_print_line(grade_ints("\x0e\x16\x49\x13\x1a\x0f\x17\x17\x02", small_got(), small_want())); _ = cx_print_line(grade_reals("\x0e\x16\x49\x14\x0f\x17\x10\x02\x02", halo_got(), halo_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x0e\x16\x49\x18\x11\x15\x18\x17\x0d", circle_count_got(), circle_count_want())); _ = cx_print_line(grade_bools("\x0e\x16\x49\x20\x0d\x14\x11\x12\x16", behind_got(), behind_want())); break :b0; };
}

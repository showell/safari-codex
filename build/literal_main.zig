...
fn ck(name: []const u8, v_: f64) []const u8 {
    return cx_concat(cx_concat(name, "\x02\x49\x50\x02"), cx_show_int(cx_real_to_int(v_)));
}

fn opening() void {
    return b0: { _ = cx_print_line(ck("\x04\x04\x08\x05\x0c\x05\x04\x08\x03\x07\x09\x03\x09\x0b\x07\x0a\x03\x03\x41\x03\x02\x02\x4a\x04\x0b\x02\x16\x11\x1d\x11\x0e\x13\x42\x02\x1c\x11\x0e\x13\x4b", @as(f64, @bitCast(@as(i64, 4862086157709187482))))); _ = cx_print_line(ck("\x04\x04\x08\x05\x0c\x05\x04\x08\x03\x07\x09\x03\x09\x0b\x07\x09\x0c\x0a\x09\x41\x03\x02\x4a\x05\x5e\x09\x03\x42\x02\x04\x0c\x02\x16\x11\x1d\x11\x0e\x13\x4b", @as(f64, @bitCast(@as(i64, -4349576520114425037))))); _ = cx_print_line(ck("\x04\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x41\x03\x02\x4a\x04\x0d\x04\x0b\x42\x02\x04\x0c\x02\x16\x11\x1d\x11\x0e\x13\x4b", @as(f64, @bitCast(@as(i64, -4348381820859684045))))); break :b0; };
}

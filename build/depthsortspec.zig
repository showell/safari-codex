...
fn mixed() *CxList(Item) {
    return cx_ll_of(Item, &[_]Item{ cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4629137466983448576))), .kind = Kind.KTree, .i_ = 0 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4621819117588971520))), .kind = Kind.KCow, .i_ = 1 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4629137466983448576))), .kind = Kind.KRail, .i_ = 2 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4632233691727265792))), .kind = Kind.KTower, .i_ = 3 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4621819117588971520))), .kind = Kind.KCat, .i_ = 4 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4626322717216342016))), .kind = Kind.KTruck, .i_ = 5 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4629137466983448576))), .kind = Kind.KTree, .i_ = 6 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4630826316843712512))), .kind = Kind.KRail, .i_ = 7 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4621819117588971520))), .kind = Kind.KCow, .i_ = 8 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4617315517961601024))), .kind = Kind.KCat, .i_ = 9 }) });
}
...
fn kind_code(k_: Kind) i64 {
    return @as(i64, switch (k_) { .KTree => 0, .KTower => 1, .KCow => 2, .KCat => 3, .KTruck => 4, .KRail => 5,  });
}
...
fn order_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4632233691727265792))), @as(f64, @bitCast(@as(i64, 4630826316843712512))), @as(f64, @bitCast(@as(i64, 4629137466983448576))), @as(f64, @bitCast(@as(i64, 4629137466983448576))), @as(f64, @bitCast(@as(i64, 4629137466983448576))), @as(f64, @bitCast(@as(i64, 4626322717216342016))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4617315517961601024))) });
}

fn stable_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 3, 7, 0, 2, 6, 5, 1, 4, 8, 9 });
}

fn kind_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1, 5, 0, 5, 0, 4, 2, 3, 2, 3 });
}

fn tie_near() *CxList(Item) {
    return cx_ll_of(Item, &[_]Item{ cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4636737291354636288))), .kind = Kind.KTree, .i_ = 0 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4636737291636111265))), .kind = Kind.KTree, .i_ = 1 }) });
}

fn tie_far() *CxList(Item) {
    return cx_ll_of(Item, &[_]Item{ cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4636737291354636288))), .kind = Kind.KTree, .i_ = 0 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4636737292058323730))), .kind = Kind.KTree, .i_ = 1 }) });
}

fn zero_near() *CxList(Item) {
    return cx_ll_of(Item, &[_]Item{ cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4602678819172646912))), .kind = Kind.KTree, .i_ = 0 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4602678819532934882))), .kind = Kind.KTree, .i_ = 1 }) });
}

fn zero_far() *CxList(Item) {
    return cx_ll_of(Item, &[_]Item{ cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4602678819172646912))), .kind = Kind.KTree, .i_ = 0 }), cx_new(ItemS{ .fwd = @as(f64, @bitCast(@as(i64, 4602678820073366837))), .kind = Kind.KTree, .i_ = 1 }) });
}

fn slack_got() *CxList(i64) {
    return cx_ll_concat(cx_ll_concat(cx_ll_concat(idxs(sort_items(tie_near()), 0), idxs(sort_items(tie_far()), 0)), idxs(sort_items(zero_near()), 0)), idxs(sort_items(zero_far()), 0));
}

fn slack_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 1, 1, 0, 0, 1, 1, 0 });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x16\x49\x10\x15\x16\x0d\x15\x02", fwds(sort_items(mixed()), 0), order_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x16\x49\x13\x0e\x0f\x20\x17\x0d", idxs(sort_items(mixed()), 0), stable_want())); _ = cx_print_line(grade_ints("\x16\x49\x22\x11\x12\x16\x02\x02", kinds(sort_items(mixed()), 0), kind_want())); _ = cx_print_line(grade_ints("\x16\x49\x13\x17\x0f\x18\x22\x02", slack_got(), slack_want())); break :b0; };
}

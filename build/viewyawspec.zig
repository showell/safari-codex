...
fn s0() RiderState {
    return cx_new(RiderStateS{ .segment = 0, .along = @as(f64, @bitCast(@as(i64, 0))), .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .v_ = @as(f64, @bitCast(@as(i64, 4599075939470750515))), .tilt = @as(f64, @bitCast(@as(i64, 0))), .heading = @as(f64, @bitCast(@as(i64, 0))), .gaze_yaw = @as(f64, @bitCast(@as(i64, 0))), .focus = @as(f64, @bitCast(@as(i64, 0))) });
}

fn s1() RiderState {
    return cx_new(RiderStateS{ .segment = 0, .along = @as(f64, @bitCast(@as(i64, 0))), .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .v_ = @as(f64, @bitCast(@as(i64, 4599075939470750515))), .tilt = @as(f64, @bitCast(@as(i64, 4593671619917905920))), .heading = @as(f64, @bitCast(@as(i64, 4616752568008179712))), .gaze_yaw = @as(f64, @bitCast(@as(i64, 4600427019358961664))), .focus = @as(f64, @bitCast(@as(i64, 0))) });
}

fn s2() RiderState {
    return cx_new(RiderStateS{ .segment = 0, .along = @as(f64, @bitCast(@as(i64, 0))), .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .v_ = @as(f64, @bitCast(@as(i64, 4599075939470750515))), .tilt = @as(f64, @bitCast(@as(i64, 4602678819172646912))), .heading = @as(f64, @bitCast(@as(i64, 4607182418800017408))), .gaze_yaw = (-@as(f64, @bitCast(@as(i64, 4598175219545276416)))), .focus = @as(f64, @bitCast(@as(i64, 0))) });
}
...
fn s4() RiderState {
    return cx_new(RiderStateS{ .segment = 0, .along = @as(f64, @bitCast(@as(i64, 0))), .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .v_ = @as(f64, @bitCast(@as(i64, 4599075939470750515))), .tilt = @as(f64, @bitCast(@as(i64, 4608308318706860032))), .heading = @as(f64, @bitCast(@as(i64, 4602678819172646912))), .gaze_yaw = @as(f64, @bitCast(@as(i64, 0))), .focus = @as(f64, @bitCast(@as(i64, 0))) });
}

fn frac_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ head_yaw_frac() });
}

fn frac_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4594572339843380019))) });
}

fn yaw_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ view_yaw_for(s0()), view_yaw_for(s1()), view_yaw_for(s2()), view_yaw_for(s3()), view_yaw_for(s4()) });
}

fn yaw_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4600764789331014451))), (-@as(f64, @bitCast(@as(i64, 4595473059768854118)))), @as(f64, @bitCast(@as(i64, 4578359381184846241))), @as(f64, @bitCast(@as(i64, 4595923419731591168))) });
}

fn head_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ heading_for(s0()), heading_for(s1()), heading_for(s2()), heading_for(s3()), heading_for(s4()) });
}

fn head_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4617195891096498995))), @as(f64, @bitCast(@as(i64, 4605606158930437734))), (-@as(f64, @bitCast(@as(i64, 4611629723432045773)))), @as(f64, @bitCast(@as(i64, 4604367669032910848))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x21\x1e\x49\x1c\x15\x0f\x18", frac_got(), frac_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x21\x1e\x49\x1e\x0f\x1b\x02", yaw_got(), yaw_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x21\x1e\x49\x14\x0d\x0f\x16", head_got(), head_want(), @as(f64, @bitCast(@as(i64, 0))))); break :b0; };
}

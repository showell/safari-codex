...
fn to_rad(d_: f64) f64 {
    return (d_ * deg());
}

fn table_deg() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4624633867356078080))), @as(f64, @bitCast(@as(i64, 4626322717216342016))), @as(f64, @bitCast(@as(i64, 4629137466983448576))), @as(f64, @bitCast(@as(i64, 4632233691727265792))), @as(f64, @bitCast(@as(i64, 4634626229029306368))), @as(f64, @bitCast(@as(i64, 4635329916471083008))) });
}

fn table_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4608519987889346445))), @as(f64, @bitCast(@as(i64, 4605741266919258849))), @as(f64, @bitCast(@as(i64, 4601976257630777115))), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4594176023076171416))), @as(f64, @bitCast(@as(i64, 4593095159165602497))) });
}

fn edge_deg() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4624352392379367424))), @as(f64, @bitCast(@as(i64, 4624296097384025293))), @as(f64, @bitCast(@as(i64, 4624859047337446605))), @as(f64, @bitCast(@as(i64, 4624915342332788736))), @as(f64, @bitCast(@as(i64, 4629278204471803904))), @as(f64, @bitCast(@as(i64, 0))), (-@as(f64, @bitCast(@as(i64, 4624633867356078080)))), (-@as(f64, @bitCast(@as(i64, 4632233691727265792)))) });
}

fn edge_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4608519987889346445))), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4608519987889346445))), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4597166413228745425))) });
}

fn env_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ a_accel(), v_max(), approach_intersection_dist() });
}

fn env_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4576918229304087675))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 4633641066610819072))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x21\x49\x0e\x0f\x20\x17\x0d", list_map(f64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, _cp0: f64) f64 { _ = _ctx4; return turn_speed(_cp0); } }; break :b4 CxFn1(f64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, list_map(f64, f64, b5: { const _Env5 = struct { fn call(_ctx5: *anyopaque, _cp0: f64) f64 { _ = _ctx5; return to_rad(_cp0); } }; break :b5 CxFn1(f64, f64){ .ctx = cx_new(_Env5{  }), .call = &_Env5.call }; }, table_deg())), table_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x21\x49\x0d\x16\x1d\x0d\x02", list_map(f64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, _cp0: f64) f64 { _ = _ctx4; return turn_speed(_cp0); } }; break :b4 CxFn1(f64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, list_map(f64, f64, b5: { const _Env5 = struct { fn call(_ctx5: *anyopaque, _cp0: f64) f64 { _ = _ctx5; return to_rad(_cp0); } }; break :b5 CxFn1(f64, f64){ .ctx = cx_new(_Env5{  }), .call = &_Env5.call }; }, edge_deg())), edge_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x21\x49\x0d\x12\x21\x02\x02", env_got(), env_want(), @as(f64, @bitCast(@as(i64, 0))))); break :b0; };
}

...
fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x21\x49\x0e\x0f\x20\x17\x0d", list_map(f64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, p0: f64) f64 { _ = _ctx4; return turn_speed(p0); } }; break :b4 CxFn1(f64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, list_map(f64, f64, b5: { const _Env5 = struct { fn call(_ctx5: *anyopaque, p0: f64) f64 { _ = _ctx5; return to_rad(p0); } }; break :b5 CxFn1(f64, f64){ .ctx = cx_new(_Env5{  }), .call = &_Env5.call }; }, table_deg())), table_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x21\x49\x0d\x16\x1d\x0d\x02", list_map(f64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, p0: f64) f64 { _ = _ctx4; return turn_speed(p0); } }; break :b4 CxFn1(f64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, list_map(f64, f64, b5: { const _Env5 = struct { fn call(_ctx5: *anyopaque, p0: f64) f64 { _ = _ctx5; return to_rad(p0); } }; break :b5 CxFn1(f64, f64){ .ctx = cx_new(_Env5{  }), .call = &_Env5.call }; }, edge_deg())), edge_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x21\x49\x0d\x12\x21\x02\x02", env_got(), env_want(), @as(f64, @bitCast(@as(i64, 0))))); break :b0; };
}

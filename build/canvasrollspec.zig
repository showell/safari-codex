...
fn band_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ roll_deadband() });
}

fn band_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4562254508917369340))) });
}

fn tilt_in() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4532020583610935537))), @as(f64, @bitCast(@as(i64, 4557750909289998844))), (-@as(f64, @bitCast(@as(i64, 4557750909289998844)))), @as(f64, @bitCast(@as(i64, 4562254047748767497))), @as(f64, @bitCast(@as(i64, 4562254508917369340))), (-@as(f64, @bitCast(@as(i64, 4562254508917369340)))), @as(f64, @bitCast(@as(i64, 4566758108544739836))), (-@as(f64, @bitCast(@as(i64, 4566758108544739836)))), @as(f64, @bitCast(@as(i64, 4599976659396224614))), (-@as(f64, @bitCast(@as(i64, 4601237667291888353)))) });
}

fn roll_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4562254508917369340))), (-@as(f64, @bitCast(@as(i64, 4562254508917369340)))), @as(f64, @bitCast(@as(i64, 4566758108544739836))), (-@as(f64, @bitCast(@as(i64, 4566758108544739836)))), @as(f64, @bitCast(@as(i64, 4599976659396224614))), (-@as(f64, @bitCast(@as(i64, 4601237667291888353)))) });
}

fn as_rider(t: f64) RiderState {
    return cx_new(RiderStateS{ .segment = 0, .along = @as(f64, @bitCast(@as(i64, 0))), .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .v_ = @as(f64, @bitCast(@as(i64, 4599075939470750515))), .tilt = t, .heading = @as(f64, @bitCast(@as(i64, 0))), .gaze_yaw = @as(f64, @bitCast(@as(i64, 0))), .focus = @as(f64, @bitCast(@as(i64, 0))) });
}
...
fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x18\x15\x49\x20\x0f\x12\x16", band_got(), band_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x18\x15\x49\x15\x10\x17\x17", roll_walk(0), roll_want(), @as(f64, @bitCast(@as(i64, 0))))); break :b0; };
}

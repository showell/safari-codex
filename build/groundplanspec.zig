...
fn fixed_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ road_chunk(), entry_road_dist() });
}

fn fixed_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4627730092099895296))), @as(f64, @bitCast(@as(i64, 4630826316843712512))) });
}

fn colour_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ road_color() });
}

fn colour_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 3421500 });
}

fn chunks_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ chunks_for(@as(f64, @bitCast(@as(i64, 4627730092099895296)))), chunks_for(@as(f64, @bitCast(@as(i64, 4627758239597566362)))), chunks_for(@as(f64, @bitCast(@as(i64, 4632233691727265792)))), chunks_for(@as(f64, @bitCast(@as(i64, 4632219617978430259)))), chunks_for(@as(f64, @bitCast(@as(i64, 4607182418800017408)))), chunks_for(@as(f64, @bitCast(@as(i64, 0)))), chunks_for(@as(f64, @bitCast(@as(i64, 4647503709213818880)))), chunks_for(@as(f64, @bitCast(@as(i64, 4644337115725824000)))), chunks_for(@as(f64, @bitCast(@as(i64, 4652992471259676672)))) });
}

fn chunks_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1, 2, 2, 2, 1, 1, 20, 13, 48 });
}
...
fn quad() *CxList(RiderPt) {
    return slice_quad(segs(), chain(), origin(), 0, 0, 20, @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4616189618054758400))));
}

fn quad_shape_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(quad()), cx_list_len(slice_quad(segs(), chain(), origin(), 0, 19, 20, @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4616189618054758400))))) });
}

fn quad_shape_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 4, 4 });
}

fn across_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ cx_list_at(quad(), 0).right, cx_list_at(quad(), 1).right, cx_list_at(quad(), 2).right, cx_list_at(quad(), 3).right });
}

fn across_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))) });
}

fn along_got() *CxList(f64) {
    return b0: { const last = slice_quad(segs(), chain(), origin(), 0, 19, 20, @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4616189618054758400)))); break :b0 cx_ll_of(f64, &[_]f64{ cx_list_at(quad(), 0).forward, cx_list_at(quad(), 3).forward, cx_list_at(last, 0).forward, cx_list_at(last, 3).forward }); };
}

fn along_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4627730092099895296))), @as(f64, @bitCast(@as(i64, 4647063904562708480))), @as(f64, @bitCast(@as(i64, 4647503709213818880))) });
}

fn seam_got() *CxList(f64) {
    return b0: { const a_ = slice_quad(segs(), chain(), origin(), 0, 3, 20, @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4616189618054758400)))); break :b0 b1: { const b_ = slice_quad(segs(), chain(), origin(), 0, 4, 20, @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4616189618054758400)))); break :b1 cx_ll_of(f64, &[_]f64{ (cx_list_at(a_, 3).forward - cx_list_at(b_, 0).forward), (cx_list_at(a_, 2).forward - cx_list_at(b_, 1).forward), (cx_list_at(a_, 3).right - cx_list_at(b_, 0).right) }); }; };
}

fn seam_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn strip() *CxList(DrawCmd) {
    return seg_road(segs(), chain(), origin(), 0, @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4651655465120301056))));
}

fn strip_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ (cx_list_len(strip()) > 0), (cx_list_len(strip()) <= chunks_for(@as(f64, @bitCast(@as(i64, 4647503709213818880))))), (cx_list_len(seg_road(segs(), chain(), cx_new(PoseS{ .along = @as(f64, @bitCast(@as(i64, 4662219572839972864))), .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .hw = @as(f64, @bitCast(@as(i64, 4611686018427387904))) }), 0, @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4651655465120301056))))) == 0) });
}

fn strip_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true });
}

fn cmd_got() *CxList(i64) {
    return b0: { const c_ = cx_list_at(strip(), (cx_list_len(strip()) - 1)); break :b0 cx_ll_of(i64, &[_]i64{ c_.tag, c_.color, c_.color2, cx_list_len(c_.geom) }); };
}

fn cmd_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 3421500, 0, 0 });
}

fn points_got() *CxList(bool) {
    return b0: { const c_ = cx_list_at(strip(), (cx_list_len(strip()) - 1)); break :b0 cx_ll_of(bool, &[_]bool{ (cx_list_len(c_.pts) >= 6), (cx_list_len(c_.pts) <= 10) }); };
}

fn points_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x1d\x1f\x49\x1c\x11\x24\x0d\x16\x02", fixed_got(), fixed_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x1d\x1f\x49\x18\x10\x17\x10\x19\x15", colour_got(), colour_want())); _ = cx_print_line(grade_ints("\x1d\x1f\x49\x18\x14\x19\x12\x22\x13", chunks_got(), chunks_want())); _ = cx_print_line(grade_ints("\x1d\x1f\x49\x13\x14\x0f\x1f\x0d\x02", quad_shape_got(), quad_shape_want())); _ = cx_print_line(grade_reals("\x1d\x1f\x49\x0f\x18\x15\x10\x13\x13", across_got(), across_want(), @as(f64, @bitCast(@as(i64, 4547007122018943789))))); _ = cx_print_line(grade_reals("\x1d\x1f\x49\x0f\x17\x10\x12\x1d\x02", along_got(), along_want(), @as(f64, @bitCast(@as(i64, 4547007122018943789))))); _ = cx_print_line(grade_reals("\x1d\x1f\x49\x13\x0d\x0f\x1a\x02\x02", seam_got(), seam_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x1d\x1f\x49\x13\x0e\x15\x11\x1f\x02", strip_got(), strip_want())); _ = cx_print_line(grade_ints("\x1d\x1f\x49\x18\x1a\x16\x02\x02\x02", cmd_got(), cmd_want())); _ = cx_print_line(grade_bools("\x1d\x1f\x49\x1f\x10\x11\x12\x0e\x13", points_got(), points_want())); break :b0; };
}

...
fn fixed_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ crown_shade_dist(), detail_dist() });
}

fn fixed_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4635329916471083008))), @as(f64, @bitCast(@as(i64, 4641240890982006784))) });
}

fn tree_at(fwd: f64) TreeItem {
    return cx_new(TreeItemS{ .right = @as(f64, @bitCast(@as(i64, 0))), .fwd = fwd, .height = @as(f64, @bitCast(@as(i64, 4618272532882417254))), .color = 1858082 });
}

fn spread() *CxList(TreeItem) {
    return cx_ll_of(TreeItem, &[_]TreeItem{ tree_at(@as(f64, @bitCast(@as(i64, 4621819117588971520)))), tree_at(@as(f64, @bitCast(@as(i64, 4626322717216342016)))), tree_at(@as(f64, @bitCast(@as(i64, 4629137466983448576)))), tree_at(@as(f64, @bitCast(@as(i64, 4630826316843712512)))), tree_at(@as(f64, @bitCast(@as(i64, 4632233691727265792)))) });
}

fn count_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ closer_count(spread(), @as(f64, @bitCast(@as(i64, 4621819117588971520))), 0), closer_count(spread(), @as(f64, @bitCast(@as(i64, 4629137466983448576))), 0), closer_count(spread(), @as(f64, @bitCast(@as(i64, 4632233691727265792))), 0), closer_count(spread(), @as(f64, @bitCast(@as(i64, 4633641066610819072))), 0), closer_count(spread(), @as(f64, @bitCast(@as(i64, 4617315517961601024))), 0), closer_count(cx_ll_empty(TreeItem), @as(f64, @bitCast(@as(i64, 4621819117588971520))), 0) });
}

fn count_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 2, 4, 5, 0, (6 - 6) });
}

fn tied() *CxList(TreeItem) {
    return cx_ll_of(TreeItem, &[_]TreeItem{ tree_at(@as(f64, @bitCast(@as(i64, 4626322717216342016)))), tree_at(@as(f64, @bitCast(@as(i64, 4626322717216342016)))), tree_at(@as(f64, @bitCast(@as(i64, 4626322717216342016)))), tree_at(@as(f64, @bitCast(@as(i64, 4626322717216342016)))) });
}

fn tie_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ closer_count(tied(), @as(f64, @bitCast(@as(i64, 4626322717216342016))), 0), closer_count(tied(), @as(f64, @bitCast(@as(i64, 4626350864714013082))), 0), closer_count(tied(), @as(f64, @bitCast(@as(i64, 4626294569718670950))), 0) });
}

fn tie_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 4, 0 });
}

fn shade_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ crown_shade_of(@as(f64, @bitCast(@as(i64, 0)))), crown_shade_of(@as(f64, @bitCast(@as(i64, 4626322717216342016)))), crown_shade_of(@as(f64, @bitCast(@as(i64, 4630826316843712512)))), crown_shade_of(@as(f64, @bitCast(@as(i64, 4635329916471083008)))), crown_shade_of(@as(f64, @bitCast(@as(i64, 4641240890982006784)))), crown_shade_of((@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4632233691727265792))))) });
}

fn shade_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4604930618986332160))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))) });
}
...
fn a_tower() TowerItem {
    return cx_new(TowerItemS{ .map = chain_map(0), .a0 = @as(f64, @bitCast(@as(i64, 4641240890982006784))), .x0 = @as(f64, @bitCast(@as(i64, 4626885667169763328))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .fwd = @as(f64, @bitCast(@as(i64, 4641240890982006784))), .off_ = @as(f64, @bitCast(@as(i64, 0))) });
}

fn base_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(tower_base(segs(), chain(), origin(), a_tower(), 0)), cx_list_len(tower_base(segs(), chain(), origin(), cx_new(TowerItemS{ .map = chain_map(0), .a0 = @as(f64, @bitCast(@as(i64, 4641240890982006784))), .x0 = @as(f64, @bitCast(@as(i64, 4626885667169763328))), .yaw = @as(f64, @bitCast(@as(i64, 4607182418800017408))), .fwd = @as(f64, @bitCast(@as(i64, 4641240890982006784))), .off_ = @as(f64, @bitCast(@as(i64, 0))) }), 0)) });
}

fn base_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 4, 4 });
}

fn corner_got() *CxList(f64) {
    return b0: { const b_ = tower_base(segs(), chain(), origin(), a_tower(), 0); break :b0 cx_ll_of(f64, &[_]f64{ cx_list_at(b_, 0).forward, cx_list_at(b_, 2).forward, cx_list_at(b_, 0).right, cx_list_at(b_, 1).right }); };
}

fn corner_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4641029784749473792))), @as(f64, @bitCast(@as(i64, 4641451997214539776))), @as(f64, @bitCast(@as(i64, 4624070917402656768))), @as(f64, @bitCast(@as(i64, 4628011567076605952))) });
}

fn drawn(a0: f64) i64 {
    return cx_list_len(draw_one_tower(segs(), chain(), origin(), cx_new(TowerItemS{ .map = chain_map(0), .a0 = a0, .x0 = @as(f64, @bitCast(@as(i64, 4626885667169763328))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .fwd = a0, .off_ = @as(f64, @bitCast(@as(i64, 0))) }), @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 0)))));
}

fn tower_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ (drawn(@as(f64, @bitCast(@as(i64, 4641240890982006784)))) > 0), (drawn(@as(f64, @bitCast(@as(i64, 4652007308841189376)))) > 0), (drawn((@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4636737291354636288))))) == 0) });
}

fn tower_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true });
}

fn cluster() *CxList(TreeItem) {
    return cx_ll_of(TreeItem, &[_]TreeItem{ tree_at(@as(f64, @bitCast(@as(i64, 4621819117588971520)))), tree_at(@as(f64, @bitCast(@as(i64, 4622382067542392832)))), tree_at(@as(f64, @bitCast(@as(i64, 4622945017495814144)))), tree_at(@as(f64, @bitCast(@as(i64, 4623507967449235456)))), tree_at(@as(f64, @bitCast(@as(i64, 4624070917402656768)))) });
}

fn tree_got() *CxList(bool) {
    return b0: { const near_1 = draw_one_tree(cluster(), 0, @as(f64, @bitCast(@as(i64, 4647503709213818880)))); break :b0 b1: { const far = draw_one_tree(cluster(), 4, @as(f64, @bitCast(@as(i64, 4647503709213818880)))); break :b1 b2: { const near_tier: i64 = cx_list_len(cx_list_at(near_1, 1).pts); break :b2 b3: { const far_tier: i64 = cx_list_len(cx_list_at(far, 1).pts); break :b3 cx_ll_of(bool, &[_]bool{ (cx_list_len(near_1) > 0), (cx_list_len(far) > 0), (near_tier > far_tier), (far_tier >= 6) }); }; }; }; };
}

fn tree_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true, true });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x11\x16\x49\x1c\x11\x24\x0d\x16\x02", fixed_got(), fixed_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x11\x16\x49\x18\x10\x19\x12\x0e\x02", count_got(), count_want())); _ = cx_print_line(grade_ints("\x11\x16\x49\x0e\x11\x0d\x02\x02\x02", tie_got(), tie_want())); _ = cx_print_line(grade_reals("\x11\x16\x49\x13\x14\x0f\x16\x0d\x02", shade_got(), shade_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x11\x16\x49\x20\x0f\x13\x0d\x02\x02", base_got(), base_want())); _ = cx_print_line(grade_reals("\x11\x16\x49\x18\x10\x15\x12\x0d\x15", corner_got(), corner_want(), @as(f64, @bitCast(@as(i64, 4547007122018943789))))); _ = cx_print_line(grade_bools("\x11\x16\x49\x0e\x10\x1b\x0d\x15\x02", tower_got(), tower_want())); _ = cx_print_line(grade_bools("\x11\x16\x49\x0e\x15\x0d\x0d\x02\x02", tree_got(), tree_want())); break :b0; };
}

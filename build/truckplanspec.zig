...
fn lengths_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ cx_list_at(segs(), 0).length, cx_list_at(segs(), 1).length, cx_list_at(segs(), 2).length });
}

fn lengths_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4644337115725824000))), @as(f64, @bitCast(@as(i64, 4645744490609377280))) });
}

fn lead_of(lead: f64) TruckAt {
    return truck_at(segs(), chain(), here(), @as(f64, @bitCast(@as(i64, 0))), lead);
}

fn present_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ lead_of(@as(f64, @bitCast(@as(i64, 4636737291354636288)))).present, lead_of(@as(f64, @bitCast(@as(i64, 4647486117027774464)))).present, lead_of(@as(f64, @bitCast(@as(i64, 4648488871632306176)))).present, lead_of(@as(f64, @bitCast(@as(i64, 4651127699538968576)))).present, lead_of(@as(f64, @bitCast(@as(i64, 4656510908468559872)))).present, lead_of(@as(f64, @bitCast(@as(i64, 0)))).present, lead_of((@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4632233691727265792))))).present });
}

fn present_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true, true, false, false, false });
}

fn landed_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ lead_of(@as(f64, @bitCast(@as(i64, 4636737291354636288)))).d_, lead_of(@as(f64, @bitCast(@as(i64, 4647486117027774464)))).d_, lead_of(@as(f64, @bitCast(@as(i64, 4648488871632306176)))).d_, lead_of(@as(f64, @bitCast(@as(i64, 4651127699538968576)))).d_ });
}

fn landed_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 0, 1, 2 });
}

fn along_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ lead_of(@as(f64, @bitCast(@as(i64, 4636737291354636288)))).along, lead_of(@as(f64, @bitCast(@as(i64, 4647486117027774464)))).along, lead_of(@as(f64, @bitCast(@as(i64, 4648488871632306176)))).along, lead_of(@as(f64, @bitCast(@as(i64, 4651127699538968576)))).along });
}

fn along_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4636737291354636288))), @as(f64, @bitCast(@as(i64, 4647486117027774464))), @as(f64, @bitCast(@as(i64, 4636737291354636288))), @as(f64, @bitCast(@as(i64, 4635329916471083008))) });
}

fn fwd_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ lead_of(@as(f64, @bitCast(@as(i64, 4636737291354636288)))).fwd, lead_of(@as(f64, @bitCast(@as(i64, 4647486117027774464)))).fwd });
}

fn fwd_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4636737291354636288))), @as(f64, @bitCast(@as(i64, 4647486117027774464))) });
}

fn none_got() *CxList(f64) {
    return b0: { const n_ = lead_of(@as(f64, @bitCast(@as(i64, 4656510908468559872)))); break :b0 cx_ll_of(f64, &[_]f64{ n_.along, n_.fwd, cx_real_from_int(n_.d_), no_truck().along, no_truck().fwd, cx_real_from_int(no_truck().d_) }); };
}

fn none_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn none_flag_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ no_truck().present, lead_of(@as(f64, @bitCast(@as(i64, 4656510908468559872)))).present });
}

fn none_flag_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, false });
}

fn behind() TruckAt {
    return truck_at(segs(), chain(), cx_new(PoseS{ .along = @as(f64, @bitCast(@as(i64, 4636737291354636288))), .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .hw = @as(f64, @bitCast(@as(i64, 4611686018427387904))) }), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4636737291354636288))));
}

fn behind_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ behind().present, truck_at(segs(), chain(), cx_new(PoseS{ .along = @as(f64, @bitCast(@as(i64, 4636666922610458624))), .across = @as(f64, @bitCast(@as(i64, 0))), .yaw = @as(f64, @bitCast(@as(i64, 0))), .hw = @as(f64, @bitCast(@as(i64, 4611686018427387904))) }), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4636737291354636288)))).present });
}
...
fn items_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(truck_items(lead_of(@as(f64, @bitCast(@as(i64, 4636737291354636288)))))), cx_list_len(truck_items(lead_of(@as(f64, @bitCast(@as(i64, 4656510908468559872)))))), cx_list_len(truck_items(no_truck())), cx_list_at(truck_items(lead_of(@as(f64, @bitCast(@as(i64, 4636737291354636288))))), 0).i_ });
}

fn items_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1, 0, 0, 0 });
}

fn item_fwd_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ cx_list_at(truck_items(lead_of(@as(f64, @bitCast(@as(i64, 4647486117027774464))))), 0).fwd });
}

fn item_fwd_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647486117027774464))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x0e\x1f\x49\x17\x0d\x12\x1d\x0e\x14", lengths_got(), lengths_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x0e\x1f\x49\x1f\x15\x0d\x13\x12\x0e", present_got(), present_want())); _ = cx_print_line(grade_ints("\x0e\x1f\x49\x17\x0f\x12\x16\x0d\x16", landed_got(), landed_want())); _ = cx_print_line(grade_reals("\x0e\x1f\x49\x0f\x17\x10\x12\x1d\x02", along_got(), along_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0e\x1f\x49\x1c\x1b\x16\x02\x02\x02", fwd_got(), fwd_want(), @as(f64, @bitCast(@as(i64, 4547007122018943789))))); _ = cx_print_line(grade_reals("\x0e\x1f\x49\x12\x10\x12\x0d\x02\x02", none_got(), none_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x0e\x1f\x49\x12\x1c\x17\x0f\x1d\x02", none_flag_got(), none_flag_want())); _ = cx_print_line(grade_bools("\x0e\x1f\x49\x20\x0d\x14\x11\x12\x16", behind_got(), behind_want())); _ = cx_print_line(grade_ints("\x0e\x1f\x49\x11\x0e\x0d\x1a\x13\x02", items_got(), items_want())); _ = cx_print_line(grade_reals("\x0e\x1f\x49\x11\x1c\x1b\x16\x02\x02", item_fwd_got(), item_fwd_want(), @as(f64, @bitCast(@as(i64, 4547007122018943789))))); break :b0; };
}

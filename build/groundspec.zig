...
fn height_got() *CxList(f64) {
    return list_map(Vec3, f64, b1: { const _Env1 = struct { fn call(_ctx1: *anyopaque, p0: Vec3) f64 { _ = _ctx1; return __lam_0(p0); } }; break :b1 CxFn1(Vec3, f64){ .ctx = cx_new(_Env1{  }), .call = &_Env1.call }; }, ground_verts(pts_a(), 0));
}

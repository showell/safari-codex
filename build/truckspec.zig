...
fn fixed_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ start_ahead(), finish_lead(), truck_turn_caution(), truck_brake_distance(), truck_max_v() });
}

fn fixed_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4636737291354636288))), @as(f64, @bitCast(@as(i64, 4605380978949069210))), @as(f64, @bitCast(@as(i64, 4633641066610819072))), @as(f64, @bitCast(@as(i64, 4613374868287651840))) });
}

fn ratio_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ truck_chase_accel(), truck_max_v(), (truck_chase_accel() / a_accel()), (truck_max_v() / v_max()) });
}

fn ratio_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4577494690056391098))), @as(f64, @bitCast(@as(i64, 4613374868287651840))), @as(f64, @bitCast(@as(i64, 4607632778762754458))), @as(f64, @bitCast(@as(i64, 4607632778762754458))) });
}

fn initial_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ truck_initial().pos, truck_initial().v_ });
}

fn initial_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4599075939470750515))) });
}

fn initial_flag_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ truck_initial().braking });
}

fn initial_flag_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false });
}

fn sched_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ truck_schedule(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4652007308841189376)))), truck_schedule(@as(f64, @bitCast(@as(i64, 4643000109586448384))), @as(f64, @bitCast(@as(i64, 4652007308841189376)))), truck_schedule(@as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4652007308841189376)))), truck_schedule(@as(f64, @bitCast(@as(i64, 4652007308841189376))), @as(f64, @bitCast(@as(i64, 4652007308841189376)))), (truck_schedule(@as(f64, @bitCast(@as(i64, 4652007308841189376))), @as(f64, @bitCast(@as(i64, 4652007308841189376)))) - @as(f64, @bitCast(@as(i64, 4652007308841189376)))), (truck_schedule(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4652007308841189376)))) - @as(f64, @bitCast(@as(i64, 0)))) });
}

fn sched_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4648928676283416576))), @as(f64, @bitCast(@as(i64, 4650248090236747776))), @as(f64, @bitCast(@as(i64, 4652552666608566272))), @as(f64, @bitCast(@as(i64, 4636737291354636288))), @as(f64, @bitCast(@as(i64, 4647503709213818880))) });
}

fn one_seg() *CxList(Segment) {
    return cx_ll_of(Segment, &[_]Segment{ segment_at(0) });
}

fn turn_dist(segs: *CxList(Segment), pos: f64) f64 {
    return switch (next_turn(segs, pos)) { .Just => |t| t.dist, .None => (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4607182418800017408)))),  };
}

fn turn_v(segs: *CxList(Segment), pos: f64) f64 {
    return switch (next_turn(segs, pos)) { .Just => |t| t.v_turn, .None => (@as(f64, @bitCast(@as(i64, 0))) - @as(f64, @bitCast(@as(i64, 4607182418800017408)))),  };
}

fn turn_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ turn_dist(one_seg(), @as(f64, @bitCast(@as(i64, 0)))), turn_dist(one_seg(), @as(f64, @bitCast(@as(i64, 4646624099911598080)))), turn_dist(one_seg(), @as(f64, @bitCast(@as(i64, 4647486117027774464)))), turn_v(one_seg(), @as(f64, @bitCast(@as(i64, 0)))), turn_v(one_seg(), @as(f64, @bitCast(@as(i64, 4646624099911598080)))), turn_speed(cx_list_at(one_seg(), 0).exit_angle) });
}

fn turn_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4632233691727265792))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4597166413228745425))), @as(f64, @bitCast(@as(i64, 4597166413228745425))) });
}

fn none_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ turn_dist(one_seg(), @as(f64, @bitCast(@as(i64, 4647503709213818880)))), turn_dist(one_seg(), @as(f64, @bitCast(@as(i64, 4651127699538968576)))), turn_dist(cx_ll_of(Segment, &[_]Segment{ segment_at(18) }), @as(f64, @bitCast(@as(i64, 0)))), turn_dist(cx_ll_empty(Segment), @as(f64, @bitCast(@as(i64, 0)))) });
}

fn none_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))) });
}

fn two_seg() *CxList(Segment) {
    return cx_ll_of(Segment, &[_]Segment{ segment_at(0), segment_at(1) });
}

fn chain_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ turn_dist(two_seg(), @as(f64, @bitCast(@as(i64, 0)))), turn_dist(two_seg(), @as(f64, @bitCast(@as(i64, 4647503709213818880)))), turn_dist(two_seg(), @as(f64, @bitCast(@as(i64, 4650248090236747776)))), turn_dist(two_seg(), @as(f64, @bitCast(@as(i64, 4650424012097191936)))) });
}

fn chain_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4644337115725824000))), @as(f64, @bitCast(@as(i64, 4626322717216342016))), (-@as(f64, @bitCast(@as(i64, 4607182418800017408)))) });
}

fn free() TruckState {
    return truck_next(cx_new(TruckStateS{ .pos = @as(f64, @bitCast(@as(i64, 4636737291354636288))), .v_ = @as(f64, @bitCast(@as(i64, 4599075939470750515))), .braking = false }), @as(f64, @bitCast(@as(i64, 0))), one_seg(), @as(f64, @bitCast(@as(i64, 4652007308841189376))));
}

fn free_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ free().v_, free().pos, (free().v_ - @as(f64, @bitCast(@as(i64, 4599075939470750515)))) });
}

fn free_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4599274097854354817))), @as(f64, @bitCast(@as(i64, 4636759176034075542))), @as(f64, @bitCast(@as(i64, 4577494690056391098))) });
}

fn ahead() TruckState {
    return truck_next(cx_new(TruckStateS{ .pos = @as(f64, @bitCast(@as(i64, 4648488871632306176))), .v_ = @as(f64, @bitCast(@as(i64, 4602678819172646912))), .braking = false }), @as(f64, @bitCast(@as(i64, 0))), one_seg(), @as(f64, @bitCast(@as(i64, 4652007308841189376))));
}

fn behind() TruckState {
    return truck_next(cx_new(TruckStateS{ .pos = @as(f64, @bitCast(@as(i64, 4645744490609377280))), .v_ = @as(f64, @bitCast(@as(i64, 4602678819172646912))), .braking = false }), @as(f64, @bitCast(@as(i64, 0))), one_seg(), @as(f64, @bitCast(@as(i64, 4652007308841189376))));
}

fn ahead_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ ahead().v_, ahead().pos, (behind().v_ - ahead().v_) });
}

fn ahead_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4648493269678817280))), @as(f64, @bitCast(@as(i64, 4577494690056391098))) });
}

fn capped() TruckState {
    return truck_next(cx_new(TruckStateS{ .pos = @as(f64, @bitCast(@as(i64, 4636737291354636288))), .v_ = truck_max_v(), .braking = false }), @as(f64, @bitCast(@as(i64, 0))), one_seg(), @as(f64, @bitCast(@as(i64, 4652007308841189376))));
}

fn capped_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ capped().v_ });
}

fn capped_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4613374868287651840))) });
}

fn free_flag_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ free().braking, ahead().braking, capped().braking });
}

fn free_flag_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, false, false });
}

fn braking() TruckState {
    return truck_next(cx_new(TruckStateS{ .pos = @as(f64, @bitCast(@as(i64, 4646624099911598080))), .v_ = @as(f64, @bitCast(@as(i64, 4599075939470750515))), .braking = false }), @as(f64, @bitCast(@as(i64, 0))), one_seg(), @as(f64, @bitCast(@as(i64, 4652007308841189376))));
}

fn brake_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ braking().v_, (braking().pos - @as(f64, @bitCast(@as(i64, 4646624099911598080)))) });
}

fn brake_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4599065408570435286))), @as(f64, @bitCast(@as(i64, 4599065408570435286))) });
}

fn brake_flag_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ braking().braking, (braking().v_ < @as(f64, @bitCast(@as(i64, 4599075939470750515)))), (braking().v_ > @as(f64, @bitCast(@as(i64, 4595566734641103425)))) });
}

fn brake_flag_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true });
}

fn settled() TruckState {
    return truck_next(cx_new(TruckStateS{ .pos = @as(f64, @bitCast(@as(i64, 4646624099911598080))), .v_ = @as(f64, @bitCast(@as(i64, 4595566734641103425))), .braking = true }), @as(f64, @bitCast(@as(i64, 0))), one_seg(), @as(f64, @bitCast(@as(i64, 4652007308841189376))));
}

fn settled_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ settled().braking, (settled().v_ == @as(f64, @bitCast(@as(i64, 4595566734641103425)))) });
}

fn settled_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, true });
}

fn boundary_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ (truck_next(cx_new(TruckStateS{ .pos = @as(f64, @bitCast(@as(i64, 4646448178051153920))), .v_ = @as(f64, @bitCast(@as(i64, 4599075939470750515))), .braking = false }), @as(f64, @bitCast(@as(i64, 0))), one_seg(), @as(f64, @bitCast(@as(i64, 4652007308841189376)))).v_ < @as(f64, @bitCast(@as(i64, 4599075939470750515)))), (truck_next(cx_new(TruckStateS{ .pos = @as(f64, @bitCast(@as(i64, 4646430585865109504))), .v_ = @as(f64, @bitCast(@as(i64, 4599075939470750515))), .braking = false }), @as(f64, @bitCast(@as(i64, 0))), one_seg(), @as(f64, @bitCast(@as(i64, 4652007308841189376)))).v_ < @as(f64, @bitCast(@as(i64, 4599075939470750515)))) });
}

fn boundary_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, false });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x0e\x22\x49\x1c\x11\x24\x0d\x16\x02", fixed_got(), fixed_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0e\x22\x49\x15\x0f\x0e\x11\x10\x02", ratio_got(), ratio_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_reals("\x0e\x22\x49\x11\x12\x11\x0e\x02\x02", initial_got(), initial_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x0e\x22\x49\x11\x1c\x17\x0f\x1d\x02", initial_flag_got(), initial_flag_want())); _ = cx_print_line(grade_reals("\x0e\x22\x49\x13\x18\x14\x0d\x16\x02", sched_got(), sched_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0e\x22\x49\x0e\x19\x15\x12\x02\x02", turn_got(), turn_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0e\x22\x49\x12\x10\x12\x0d\x02\x02", none_got(), none_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0e\x22\x49\x18\x14\x0f\x11\x12\x02", chain_got(), chain_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x0e\x22\x49\x1c\x15\x0d\x0d\x02\x02", free_got(), free_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_reals("\x0e\x22\x49\x0f\x14\x0d\x0f\x16\x02", ahead_got(), ahead_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_reals("\x0e\x22\x49\x18\x0f\x1f\x02\x02\x02", capped_got(), capped_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_bools("\x0e\x22\x49\x1c\x1c\x17\x0f\x1d\x02", free_flag_got(), free_flag_want())); _ = cx_print_line(grade_reals("\x0e\x22\x49\x20\x15\x0f\x22\x0d\x02", brake_got(), brake_want(), @as(f64, @bitCast(@as(i64, 4427486594234968593))))); _ = cx_print_line(grade_bools("\x0e\x22\x49\x20\x1c\x17\x0f\x1d\x02", brake_flag_got(), brake_flag_want())); _ = cx_print_line(grade_bools("\x0e\x22\x49\x13\x0d\x0e\x0e\x17\x0d", settled_got(), settled_want())); _ = cx_print_line(grade_bools("\x0e\x22\x49\x20\x10\x19\x12\x16\x02", boundary_got(), boundary_want())); break :b0; };
}

...
fn focal_for_lean(lean_frac: f64) f64 {
    return (focal() * (@as(f64, @bitCast(@as(i64, 4607182418800017408))) - (((@as(f64, @bitCast(@as(i64, 4607182418800017408))) - min_focal_factor()) * lean_frac) * lean_frac)));
}

fn focal_for_gaze(attention: f64) f64 {
    return (focal() * (@as(f64, @bitCast(@as(i64, 4607182418800017408))) - ((@as(f64, @bitCast(@as(i64, 4607182418800017408))) - min_gaze_focal_factor()) * attention)));
}

fn cam_focal(lean_frac: f64, attention: f64) f64 {
    return b0: { const a_: f64 = focal_for_lean(lean_frac); break :b0 b1: { const b_: f64 = focal_for_gaze(attention); break :b1 (if ((a_ < b_)) a_ else b_); }; };
}
...
fn base_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ camera_w(), fov_deg(), focal() });
}

fn base_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4651655465120301056))), @as(f64, @bitCast(@as(i64, 4634626229029306368))), @as(f64, @bitCast(@as(i64, 4649241034723037974))) });
}

fn lean_in() *CxList(f64) {
...
fn lean_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4649241034723037974))), @as(f64, @bitCast(@as(i64, 4648996073330060675))), @as(f64, @bitCast(@as(i64, 4648261189151128777))), @as(f64, @bitCast(@as(i64, 4646357948926132688))), @as(f64, @bitCast(@as(i64, 4642645763029919621))) });
}

fn gaze_in() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4609434218613702656))) });
}

fn gaze_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4649241034723037974))), @as(f64, @bitCast(@as(i64, 4648065220036746937))), @as(f64, @bitCast(@as(i64, 4646063995254559930))), @as(f64, @bitCast(@as(i64, 4643712365881977857))) });
}

fn cam_lean() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4606281698874543309))), @as(f64, @bitCast(@as(i64, 4603579539098121011))) });
}

fn cam_gaze() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4602678819172646912))) });
}

fn cam_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4649241034723037974))), @as(f64, @bitCast(@as(i64, 4642645763029919621))), @as(f64, @bitCast(@as(i64, 4646063995254559930))), @as(f64, @bitCast(@as(i64, 4648261189151128777))), @as(f64, @bitCast(@as(i64, 4644182691756494272))), @as(f64, @bitCast(@as(i64, 4647830057099488730))) });
}

...
fn gaze() Critter {
    return gaze_pig(@as(f64, @bitCast(@as(i64, 4652007308841189376))), @as(f64, @bitCast(@as(i64, 4611686018427387904))));
}

fn gaze_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ gaze().along, gaze().across, gaze().height, pig_height(), pig_dist_before_end(), gaze_pig_along_offset() });
}

fn gaze_got_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4651497135445901312))), @as(f64, @bitCast(@as(i64, 4622945017495814144))), @as(f64, @bitCast(@as(i64, 4607632778762754458))), @as(f64, @bitCast(@as(i64, 4607632778762754458))), @as(f64, @bitCast(@as(i64, 4633641066610819072))), @as(f64, @bitCast(@as(i64, 4611686018427387904))) });
}

fn gaze_kind_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ gaze().codepoint, pig_cp(), pig_novelty_count(), big_herd_cols(), big_herd_rows() });
}

fn gaze_kind_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 128022, 128022, 2, 7, 7 });
}

fn gaze_face_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ gaze().face_right });
}

fn gaze_face_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false });
}

fn herd() *CxList(Critter) {
    return fill_pig_herd(@as(f64, @bitCast(@as(i64, 4652007308841189376))));
}

fn herd_count_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(herd()), cx_list_len(fill_pig_herd(@as(f64, @bitCast(@as(i64, 4647503709213818880))))) });
}

fn herd_count_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 49, 49 });
}

fn along_of(r_: i64, c_: i64) f64 {
    return cx_list_at(herd(), ((r_ * 7) + c_)).along;
}

fn row_alongs(r_: i64) *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ along_of(r_, 0), along_of(r_, 1), along_of(r_, 2), along_of(r_, 3), along_of(r_, 4), along_of(r_, 5), along_of(r_, 6) });
}

fn herd_along_got() *CxList(f64) {
    return cx_ll_concat(cx_ll_concat(row_alongs(0), row_alongs(3)), row_alongs(6));
}

fn herd_along_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4651426766701723648))), @as(f64, @bitCast(@as(i64, 4651461951073812480))), @as(f64, @bitCast(@as(i64, 4651497135445901312))), @as(f64, @bitCast(@as(i64, 4651532319817990144))), @as(f64, @bitCast(@as(i64, 4651567504190078976))), @as(f64, @bitCast(@as(i64, 4651602688562167808))), @as(f64, @bitCast(@as(i64, 4651637872934256640))), @as(f64, @bitCast(@as(i64, 4651585096376123392))), @as(f64, @bitCast(@as(i64, 4651620280748212224))), @as(f64, @bitCast(@as(i64, 4651655465120301056))), @as(f64, @bitCast(@as(i64, 4651690649492389888))), @as(f64, @bitCast(@as(i64, 4651725833864478720))), @as(f64, @bitCast(@as(i64, 4651761018236567552))), @as(f64, @bitCast(@as(i64, 4651796202608656384))), @as(f64, @bitCast(@as(i64, 4651743426050523136))), @as(f64, @bitCast(@as(i64, 4651778610422611968))), @as(f64, @bitCast(@as(i64, 4651813794794700800))), @as(f64, @bitCast(@as(i64, 4651848979166789632))), @as(f64, @bitCast(@as(i64, 4651884163538878464))), @as(f64, @bitCast(@as(i64, 4651919347910967296))), @as(f64, @bitCast(@as(i64, 4651954532283056128))) });
}

fn herd_across_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ cx_list_at(herd(), 0).across, cx_list_at(herd(), 6).across, cx_list_at(herd(), 7).across, cx_list_at(herd(), 13).across, cx_list_at(herd(), 14).across, cx_list_at(herd(), 21).across, cx_list_at(herd(), 28).across, cx_list_at(herd(), 35).across, cx_list_at(herd(), 42).across, cx_list_at(herd(), 48).across });
}

fn herd_across_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4622945017495814144))), @as(f64, @bitCast(@as(i64, 4622945017495814144))), @as(f64, @bitCast(@as(i64, 4625759767262920704))), @as(f64, @bitCast(@as(i64, 4625759767262920704))), @as(f64, @bitCast(@as(i64, 4627448617123184640))), @as(f64, @bitCast(@as(i64, 4629137466983448576))), @as(f64, @bitCast(@as(i64, 4630263366890291200))), @as(f64, @bitCast(@as(i64, 4631107791820423168))), @as(f64, @bitCast(@as(i64, 4631952216750555136))), @as(f64, @bitCast(@as(i64, 4631952216750555136))) });
}

fn herd_kind_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_at(herd(), 0).codepoint, cx_list_at(herd(), 48).codepoint });
}

fn herd_kind_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 128022, 128022 });
}

fn row() *CxList(Critter) {
    return fill_pig_row(@as(f64, @bitCast(@as(i64, 4652007308841189376))));
}

fn row_count_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(row()), cx_list_len(pig_row_front()), cx_list_len(pig_row_back()) });
}

fn row_count_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 10, 4, 6 });
}

fn row_along_got() *CxList(f64) {
    return list_map(Critter, f64, b1: { const _Env1 = struct { fn call(_ctx1: *anyopaque, _cp0: Critter) f64 { _ = _ctx1; return __lam_0(_cp0); } }; break :b1 CxFn1(Critter, f64){ .ctx = cx_new(_Env1{  }), .call = &_Env1.call }; }, row());
}

fn row_along_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4651426766701723648))), @as(f64, @bitCast(@as(i64, 4651461951073812480))), @as(f64, @bitCast(@as(i64, 4651497135445901312))), @as(f64, @bitCast(@as(i64, 4651532319817990144))), @as(f64, @bitCast(@as(i64, 4651391582329634816))), @as(f64, @bitCast(@as(i64, 4651426766701723648))), @as(f64, @bitCast(@as(i64, 4651461951073812480))), @as(f64, @bitCast(@as(i64, 4651497135445901312))), @as(f64, @bitCast(@as(i64, 4651532319817990144))), @as(f64, @bitCast(@as(i64, 4651567504190078976))) });
}

fn row_across_got() *CxList(f64) {
    return list_map(Critter, f64, b1: { const _Env1 = struct { fn call(_ctx1: *anyopaque, _cp0: Critter) f64 { _ = _ctx1; return __lam_1(_cp0); } }; break :b1 CxFn1(Critter, f64){ .ctx = cx_new(_Env1{  }), .call = &_Env1.call }; }, row());
}

fn row_across_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4622945017495814144))), @as(f64, @bitCast(@as(i64, 4622945017495814144))), @as(f64, @bitCast(@as(i64, 4622945017495814144))), @as(f64, @bitCast(@as(i64, 4622945017495814144))), @as(f64, @bitCast(@as(i64, 4625759767262920704))), @as(f64, @bitCast(@as(i64, 4625759767262920704))), @as(f64, @bitCast(@as(i64, 4625759767262920704))), @as(f64, @bitCast(@as(i64, 4625759767262920704))), @as(f64, @bitCast(@as(i64, 4625759767262920704))), @as(f64, @bitCast(@as(i64, 4625759767262920704))) });
}

fn offsets_got() *CxList(f64) {
    return cx_ll_concat(cx_ll_concat(pig_row_front(), pig_row_back()), cx_ll_of(f64, &[_]f64{ pig_back_row_offset(), pig_herd_first_col(), pig_col_spacing(), pig_row_depth(), pig_jitter_along(), pig_jitter_across() }));
}

fn offsets_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4618441417868443648)))), (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4618441417868443648))), (-@as(f64, @bitCast(@as(i64, 4621819117588971520)))), (-@as(f64, @bitCast(@as(i64, 4618441417868443648)))), (-@as(f64, @bitCast(@as(i64, 4611686018427387904)))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4618441417868443648))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4618441417868443648))), (-@as(f64, @bitCast(@as(i64, 4618441417868443648)))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4618441417868443648))), @as(f64, @bitCast(@as(i64, 4608083138725491507))), @as(f64, @bitCast(@as(i64, 4607182418800017408))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x1f\x1d\x49\x1d\x0f\x26\x0d\x02\x02", gaze_got(), gaze_got_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x1f\x1d\x49\x22\x11\x12\x16\x02\x02", gaze_kind_got(), gaze_kind_want())); _ = cx_print_line(grade_bools("\x1f\x1d\x49\x1c\x0f\x18\x0d\x02\x02", gaze_face_got(), gaze_face_want())); _ = cx_print_line(grade_ints("\x1f\x1d\x49\x12\x14\x0d\x15\x16\x02", herd_count_got(), herd_count_want())); _ = cx_print_line(grade_ints("\x1f\x1d\x49\x14\x22\x11\x12\x16\x02", herd_kind_got(), herd_kind_want())); _ = cx_print_line(grade_ints("\x1f\x1d\x49\x12\x15\x10\x1b\x02\x02", row_count_got(), row_count_want())); _ = cx_print_line(grade_reals("\x1f\x1d\x49\x15\x10\x1b\x0f\x02\x02", row_along_got(), row_along_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x1f\x1d\x49\x15\x10\x1b\x24\x02\x02", row_across_got(), row_across_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x1f\x1d\x49\x10\x1c\x1c\x13\x02\x02", offsets_got(), offsets_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x1f\x1d\x49\x14\x0d\x15\x16\x0f\x02", herd_along_got(), herd_along_want(), @as(f64, @bitCast(@as(i64, 4608083138725491507))))); _ = cx_print_line(grade_reals("\x1f\x1d\x49\x14\x0d\x15\x16\x24\x02", herd_across_got(), herd_across_want(), @as(f64, @bitCast(@as(i64, 4607182418800017408))))); break :b0; };
}

fn __lam_0(p_: Critter) f64 {
    return p_.along;
}

fn __lam_1(p_: Critter) f64 {
    return p_.across;
}

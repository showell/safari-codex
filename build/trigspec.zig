...
fn ang() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 4604480259023595110))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4609434218613702656))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4613937818241073152))), @as(f64, @bitCast(@as(i64, 4616752568008179712))), @as(f64, @bitCast(@as(i64, 4618441417868443648))) });
}

fn sin_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4598995238688307763))), @as(f64, @bitCast(@as(i64, 4603977816617654712))), @as(f64, @bitCast(@as(i64, 4605754516372524270))), @as(f64, @bitCast(@as(i64, 4607159855645224331))), @as(f64, @bitCast(@as(i64, 4606365442650518597))), @as(f64, @bitCast(@as(i64, 4594252404416238939))), (-@as(f64, @bitCast(@as(i64, 4606980028092596352)))), (-@as(f64, @bitCast(@as(i64, 4598705122052186816)))) });
}

fn cos_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4606780125658155450))), @as(f64, @bitCast(@as(i64, 4605064305524579731))), @as(f64, @bitCast(@as(i64, 4603041830072026764))), @as(f64, @bitCast(@as(i64, 4589761573224315303))), (-@as(f64, @bitCast(@as(i64, 4601168254869926405)))), (-@as(f64, @bitCast(@as(i64, 4607092279222855122)))), (-@as(f64, @bitCast(@as(i64, 4596762739360677226)))), @as(f64, @bitCast(@as(i64, 4606823664635618037))) });
}

fn atan_in() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4598175219545276416))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4616189618054758400))) });
}

fn atan_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4597994306818310366))), @as(f64, @bitCast(@as(i64, 4602023952714414927))), @as(f64, @bitCast(@as(i64, 4605249457297304856))), @as(f64, @bitCast(@as(i64, 4607664973725548100))), @as(f64, @bitCast(@as(i64, 4608649771108703485))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x0e\x49\x13\x11\x12\x02", list_map(f64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, _cp0: f64) f64 { _ = _ctx4; return r_sin(_cp0); } }; break :b4 CxFn1(f64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, ang()), sin_want(), @as(f64, @bitCast(@as(i64, 4502148214488346440))))); _ = cx_print_line(grade_reals("\x0e\x49\x18\x10\x13\x02", list_map(f64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, _cp0: f64) f64 { _ = _ctx4; return r_cos(_cp0); } }; break :b4 CxFn1(f64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, ang()), cos_want(), @as(f64, @bitCast(@as(i64, 4506651814115716936))))); _ = cx_print_line(grade_reals("\x0e\x49\x0f\x0e\x0f\x12", list_map(f64, f64, b4: { const _Env4 = struct { fn call(_ctx4: *anyopaque, _cp0: f64) f64 { _ = _ctx4; return r_atan(_cp0); } }; break :b4 CxFn1(f64, f64){ .ctx = cx_new(_Env4{  }), .call = &_Env4.call }; }, atan_in()), atan_want(), @as(f64, @bitCast(@as(i64, 4382569440205035030))))); break :b0; };
}

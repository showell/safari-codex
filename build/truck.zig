...
fn next_turn_loop(_arg_segs: *CxList(Segment), pos: f64, i_: i64, cum0: f64) Maybe(Turn) {
    return (if ((i_ >= cx_list_len(_arg_segs))) Maybe(Turn){ .None = {} } else next_turn_step(_arg_segs, pos, i_, (cum0 + cx_list_at(_arg_segs, i_).length)));
}

fn next_turn_step(_arg_segs: *CxList(Segment), pos: f64, i_: i64, cum: f64) Maybe(Turn) {
    return b0: { const s_ = cx_list_at(_arg_segs, i_); break :b0 (if ((pos < cum)) (if (s_.terminates) Maybe(Turn){ .None = {} } else Maybe(Turn){ .Just = cx_new(TurnS{ .dist = (cum - pos), .v_turn = turn_speed(s_.exit_angle) }) }) else next_turn_loop(_arg_segs, pos, (i_ +% 1), cum)); };
}

fn next_turn(_arg_segs: *CxList(Segment), pos: f64) Maybe(Turn) {
    return next_turn_loop(_arg_segs, pos, 0, @as(f64, @bitCast(@as(i64, 0))));
}

fn truck_next(truck: TruckState, rider_dist: f64, _arg_segs: *CxList(Segment), l_: f64) TruckState {
    return b0: { const scheduled: f64 = ((rider_dist + finish_lead()) + ((start_ahead() - finish_lead()) * (@as(f64, @bitCast(@as(i64, 4607182418800017408))) - (rider_dist / l_)))); break :b0 switch (next_turn(_arg_segs, truck.pos)) { .Just => |turn| (if ((turn.dist <= truck_brake_distance())) truck_braking(truck, turn) else truck_free(truck, scheduled)), .None => truck_free(truck, scheduled),  }; };
}
...
fn g_tk_pos() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647508986869632205))), @as(f64, @bitCast(@as(i64, 4648499523700956070))), @as(f64, @bitCast(@as(i64, 4651138254850595226))), @as(f64, @bitCast(@as(i64, 4647009964633312115))), @as(f64, @bitCast(@as(i64, 4647424159987353938))), @as(f64, @bitCast(@as(i64, 4647489241400015952))), @as(f64, @bitCast(@as(i64, 4656521903584837632))), @as(f64, @bitCast(@as(i64, 4664749549095485440))), @as(f64, @bitCast(@as(i64, 4665079402583818240))) });
}

fn g_tk_v() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 4608132678771752545))), @as(f64, @bitCast(@as(i64, 4608083138725491507))), @as(f64, @bitCast(@as(i64, 4611388145844433992))), @as(f64, @bitCast(@as(i64, 4602285279865400500))), @as(f64, @bitCast(@as(i64, 4595566735001391395))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4607182418800017408))) });
}

fn g_tk_braking() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ false, false, false, true, true, false, false, false, false });
}

fn g_tk_initial() *CxList(f64) {
...
fn course() f64 {
    return course_length_from(segs(), 0);
}

fn poses() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4648488871632306176))), @as(f64, @bitCast(@as(i64, 4651127699538968576))), @as(f64, @bitCast(@as(i64, 4646975943632486400))), @as(f64, @bitCast(@as(i64, 4647415748283596800))), @as(f64, @bitCast(@as(i64, 4647486117027774464))), @as(f64, @bitCast(@as(i64, 4656510908468559872))), @as(f64, @bitCast(@as(i64, 4664748449583857664))), @as(f64, @bitCast(@as(i64, 4665078303072190464))) });
}

fn vs_() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4599075939470750515))), @as(f64, @bitCast(@as(i64, 4608083138725491507))), @as(f64, @bitCast(@as(i64, 4608083138725491507))), @as(f64, @bitCast(@as(i64, 4611686018427387904))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4591870180066957722))), @as(f64, @bitCast(@as(i64, 4612811918334230528))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4607182418800017408))) });
}

fn rds() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4643985272004935680))), @as(f64, @bitCast(@as(i64, 4643985272004935680))), @as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 4641240890982006784))), @as(f64, @bitCast(@as(i64, 4654311885213007872))), @as(f64, @bitCast(@as(i64, 4664418596095524864))), @as(f64, @bitCast(@as(i64, 4664858400746635264))) });
}

fn outs(i_: i64) *CxList(TruckState) {
    return (if ((i_ >= cx_list_len(poses()))) cx_ll_empty(TruckState) else cx_ll_concat(cx_ll_of(TruckState, &[_]TruckState{ truck_next(cx_new(TruckStateS{ .pos = cx_list_at(poses(), i_), .v_ = cx_list_at(vs_(), i_), .braking = false }), cx_list_at(rds(), i_), segs(), course()) }), outs((i_ +% 1))));
}

fn all_outs() *CxList(TruckState) {
    return outs(0);
}

fn f_pos(ts: *CxList(TruckState), i_: i64) *CxList(f64) {
    return (if ((i_ >= cx_list_len(ts))) cx_ll_empty(f64) else cx_ll_concat(cx_ll_of(f64, &[_]f64{ cx_list_at(ts, i_).pos }), f_pos(ts, (i_ +% 1))));
}

fn f_v(ts: *CxList(TruckState), i_: i64) *CxList(f64) {
    return (if ((i_ >= cx_list_len(ts))) cx_ll_empty(f64) else cx_ll_concat(cx_ll_of(f64, &[_]f64{ cx_list_at(ts, i_).v_ }), f_v(ts, (i_ +% 1))));
}

fn f_braking(ts: *CxList(TruckState), i_: i64) *CxList(bool) {
    return (if ((i_ >= cx_list_len(ts))) cx_ll_empty(bool) else cx_ll_concat(cx_ll_of(bool, &[_]bool{ cx_list_at(ts, i_).braking }), f_braking(ts, (i_ +% 1))));
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_px("\x0e\x22\x49\x1f\x10\x13\x02\x02\x02\x02\x02", f_pos(all_outs(), 0), g_tk_pos(), @as(f64, @bitCast(@as(i64, 4547007122018943789))), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_rel("\x0e\x22\x49\x21\x02\x02\x02\x02\x02\x02\x02", f_v(all_outs(), 0), g_tk_v(), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); _ = cx_print_line(grade_bools("\x0e\x22\x49\x20\x15\x0f\x22\x11\x12\x1d\x02", f_braking(all_outs(), 0), g_tk_braking())); _ = cx_print_line(grade_rel("\x0e\x22\x49\x11\x12\x11\x0e\x11\x0f\x17\x02", cx_ll_of(f64, &[_]f64{ truck_initial().pos, truck_initial().v_ }), g_tk_initial(), @as(f64, @bitCast(@as(i64, 4517329193108106637))))); break :b0; };
}

...
fn present_got() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ species_of(Creature.Elephant).present, species_of(Creature.Giraffe).present, species_of(Creature.Zebra).present, species_of(Creature.Rhino).present, species_of(Creature.DuckPond).present, species_of(Creature.NoCreature).present });
}

fn present_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, true, true, false, false });
}

fn cp_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ species_of(Creature.Elephant).cp_, species_of(Creature.Giraffe).cp_, species_of(Creature.Zebra).cp_, species_of(Creature.Rhino).cp_, species_of(Creature.DuckPond).cp_, species_of(Creature.NoCreature).cp_ });
}

fn cp_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 128024, 129426, 129427, 129423, 0, 0 });
}

fn height_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ species_of(Creature.Elephant).adult_h, species_of(Creature.Giraffe).adult_h, species_of(Creature.Zebra).adult_h, species_of(Creature.Rhino).adult_h, species_of(Creature.DuckPond).adult_h });
}

fn height_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4613487458278336102))), @as(f64, @bitCast(@as(i64, 4616752568008179712))), @as(f64, @bitCast(@as(i64, 4609884578576439706))), @as(f64, @bitCast(@as(i64, 4612136378390124954))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn dims_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ adult_rail_buffer(), baby_ratio(), baby_beyond() });
}

fn dims_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4609434218613702656))), @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4624070917402656768))) });
}

fn pair_a() *CxList(Critter) {
    return corner_critters(Creature.Elephant, @as(f64, @bitCast(@as(i64, 4636737291354636288))), true, @as(f64, @bitCast(@as(i64, 4611686018427387904))));
}

fn pair_b() *CxList(Critter) {
    return corner_critters(Creature.Giraffe, @as(f64, @bitCast(@as(i64, 4632233691727265792))), false, @as(f64, @bitCast(@as(i64, 4611686018427387904))));
}

fn pair_c() *CxList(Critter) {
    return corner_critters(Creature.Zebra, @as(f64, @bitCast(@as(i64, 4621819117588971520))), true, @as(f64, @bitCast(@as(i64, 4612811918334230528))));
}

fn pair_d() *CxList(Critter) {
    return corner_critters(Creature.Rhino, @as(f64, @bitCast(@as(i64, 0))), false, @as(f64, @bitCast(@as(i64, 4611686018427387904))));
}

fn all_four() *CxList(Critter) {
    return cx_ll_concat(cx_ll_concat(cx_ll_concat(pair_a(), pair_b()), pair_c()), pair_d());
}
...
fn across_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4617202927970916762)))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4618159942891732992))), @as(f64, @bitCast(@as(i64, 0))), (-@as(f64, @bitCast(@as(i64, 4617090337980232499)))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4616865157998863974))), @as(f64, @bitCast(@as(i64, 0))) });
}
...
fn along_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4636737291354636288))), @as(f64, @bitCast(@as(i64, 4637722453773123584))), @as(f64, @bitCast(@as(i64, 4632233691727265792))), @as(f64, @bitCast(@as(i64, 4634204016564240384))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4627448617123184640))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4624070917402656768))) });
}
...
fn ch_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4613487458278336102))), @as(f64, @bitCast(@as(i64, 4608983858650965606))), @as(f64, @bitCast(@as(i64, 4616752568008179712))), @as(f64, @bitCast(@as(i64, 4612248968380809216))), @as(f64, @bitCast(@as(i64, 4609884578576439706))), @as(f64, @bitCast(@as(i64, 4605380978949069210))), @as(f64, @bitCast(@as(i64, 4612136378390124954))), @as(f64, @bitCast(@as(i64, 4607632778762754458))) });
}
...
fn ccp_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 128024, 128024, 129426, 129426, 129427, 129427, 129423, 129423 });
}
...
fn face_want() *CxList(bool) {
    return cx_ll_of(bool, &[_]bool{ true, true, false, false, true, true, false, false });
}

fn count_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(pair_a()), cx_list_len(corner_critters(Creature.DuckPond, @as(f64, @bitCast(@as(i64, 4636737291354636288))), true, @as(f64, @bitCast(@as(i64, 4611686018427387904))))), cx_list_len(corner_critters(Creature.NoCreature, @as(f64, @bitCast(@as(i64, 4636737291354636288))), true, @as(f64, @bitCast(@as(i64, 4611686018427387904))))) });
}

fn count_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 2, 0, 0 });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_bools("\x13\x22\x49\x1f\x15\x0d\x13\x0d\x12\x0e", present_got(), present_want())); _ = cx_print_line(grade_ints("\x13\x22\x49\x18\x1f\x02\x02\x02\x02", cp_got(), cp_want())); _ = cx_print_line(grade_reals("\x13\x22\x49\x14\x0d\x11\x1d\x14\x0e", height_got(), height_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x13\x22\x49\x16\x11\x1a\x13\x02\x02", dims_got(), dims_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x13\x22\x49\x0f\x18\x15\x10\x13\x13", across_got(), across_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x13\x22\x49\x0f\x17\x10\x12\x1d\x02", along_got(), along_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x13\x22\x49\x18\x14\x02\x02\x02\x02", ch_got(), ch_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x13\x22\x49\x18\x18\x1f\x02\x02\x02", ccp_got(), ccp_want())); _ = cx_print_line(grade_bools("\x13\x22\x49\x1c\x0f\x18\x0d\x02\x02", face_got(), face_want())); _ = cx_print_line(grade_ints("\x13\x22\x49\x18\x10\x19\x12\x0e\x02", count_got(), count_want())); break :b0; };
}
...
fn __lam_3(c_: Critter) i64 {
    return c_.codepoint;
}

fn __lam_4(c_: Critter) bool {
    return c_.face_right;
}

...
fn joint_apex(segs: *CxList(Segment), ch: *CxList(i64), _arg_pose: Pose, from_map: Mapper, to_map: Mapper, from_len: f64, from_w: f64, to_w: f64, exit_right: bool) RiderPt {
    return b0: { const fcu: f64 = outer_cu(exit_right, from_w); break :b0 b1: { const tx: f64 = outer_cu(exit_right, to_w); break :b1 line_meet(map_pt(segs, ch, _arg_pose, from_map, from_len, fcu), map_pt(segs, ch, _arg_pose, from_map, (from_len + @as(f64, @bitCast(@as(i64, 4607182418800017408)))), fcu), map_pt(segs, ch, _arg_pose, to_map, @as(f64, @bitCast(@as(i64, 0))), tx), map_pt(segs, ch, _arg_pose, to_map, @as(f64, @bitCast(@as(i64, 4607182418800017408))), tx)); }; };
}
...
fn outer_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ outer_cu(true, @as(f64, @bitCast(@as(i64, 4616189618054758400)))), outer_cu(false, @as(f64, @bitCast(@as(i64, 4616189618054758400)))), outer_cu(true, @as(f64, @bitCast(@as(i64, 4620130267728707584)))), outer_cu(false, @as(f64, @bitCast(@as(i64, 4620130267728707584)))) });
}

fn outer_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4620130267728707584))) });
}
...
fn here() Mapper {
    return cx_new(MapperS{ .is_chain = true, .d_ = 0, .prev_len = @as(f64, @bitCast(@as(i64, 0))), .prev_angle = @as(f64, @bitCast(@as(i64, 0))), .prev_right = false, .prev_w = @as(f64, @bitCast(@as(i64, 0))) });
}

fn apex_got() *CxList(f64) {
    return b0: { const r_ = joint_apex(cx_ll_empty(Segment), cx_ll_empty(i64), pose(), behind_right(), here(), @as(f64, @bitCast(@as(i64, 4643985272004935680))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), true); break :b0 b1: { const l_ = joint_apex(cx_ll_empty(Segment), cx_ll_empty(i64), pose(), behind_left(), here(), @as(f64, @bitCast(@as(i64, 4643985272004935680))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), false); break :b1 cx_ll_of(f64, &[_]f64{ r_.right, r_.forward, l_.right, l_.forward }); }; };
}

fn apex_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4625561974083962982))), (-@as(f64, @bitCast(@as(i64, 4636767600297211369)))), @as(f64, @bitCast(@as(i64, 4626717750094408435))), (-@as(f64, @bitCast(@as(i64, 4636776204459260803)))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x23\x0e\x49\x10\x19\x0e\x0d\x15", outer_got(), outer_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_rel("\x23\x0e\x49\x0f\x1f\x0d\x24\x02", apex_got(), apex_want(), @as(f64, @bitCast(@as(i64, 4502148214488346440))))); break :b0; };
}

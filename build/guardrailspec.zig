...
fn dims_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ rail_height(), rail_thickness(), rail_post_width(), bar_top(), bar_bot(), half_post() });
}

fn dims_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4602678819172646912))), @as(f64, @bitCast(@as(i64, 4591870180066957722))), @as(f64, @bitCast(@as(i64, 4581421828931458171))), @as(f64, @bitCast(@as(i64, 4603129179135383962))), @as(f64, @bitCast(@as(i64, 4601778099247172813))), @as(f64, @bitCast(@as(i64, 4576918229304087675))) });
}

fn fixed_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ rail_metal(), rail_post_metal(), rail_runout(), max_rail_polys() });
}

fn fixed_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 12765135, 10133672, 10, 3072 });
}

fn pt(r_: f64, f: f64) RiderPt {
    return cx_new(RiderPtS{ .right = r_, .forward = f });
}

fn straight() *CxList(RiderPt) {
    return cx_ll_of(RiderPt, &[_]RiderPt{ pt(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520)))), pt(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4626322717216342016)))), pt(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4629137466983448576)))) });
}

fn rails() *CxList(RailPoly) {
    return rail_emit(straight());
}

fn shape_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(rails()), cx_list_len(bars(straight(), 0)), cx_list_len(posts(straight(), 0)), cx_list_len(cx_list_at(rails(), 0).v_), cx_list_len(cx_list_at(rails(), 4).v_) });
}

fn shape_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 5, 2, 3, 4, 4 });
}

fn colour_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_at(rails(), 0).color, cx_list_at(rails(), 1).color, cx_list_at(rails(), 2).color, cx_list_at(rails(), 3).color, cx_list_at(rails(), 4).color });
}

fn colour_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 12765135, 12765135, 10133672, 10133672, 10133672 });
}

fn fwd_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ cx_list_at(rails(), 0).fwd, cx_list_at(rails(), 1).fwd, cx_list_at(rails(), 2).fwd, cx_list_at(rails(), 3).fwd, cx_list_at(rails(), 4).fwd });
}

fn fwd_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4624633867356078080))), @as(f64, @bitCast(@as(i64, 4627730092099895296))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4626322717216342016))), @as(f64, @bitCast(@as(i64, 4629137466983448576))) });
}

fn bar_got() *CxList(f64) {
    return b0: { const v_ = cx_list_at(rails(), 0).v_; break :b0 cx_ll_of(f64, &[_]f64{ cx_list_at(v_, 0).forward, cx_list_at(v_, 1).forward, cx_list_at(v_, 2).forward, cx_list_at(v_, 3).forward, cx_list_at(v_, 0).height, cx_list_at(v_, 1).height, cx_list_at(v_, 2).height, cx_list_at(v_, 3).height }); };
}

fn bar_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4626322717216342016))), @as(f64, @bitCast(@as(i64, 4626322717216342016))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4601778099247172813))), @as(f64, @bitCast(@as(i64, 4601778099247172813))), @as(f64, @bitCast(@as(i64, 4603129179135383962))), @as(f64, @bitCast(@as(i64, 4603129179135383962))) });
}

fn post_got() *CxList(f64) {
    return b0: { const v_ = cx_list_at(rails(), 2).v_; break :b0 cx_ll_of(f64, &[_]f64{ cx_list_at(v_, 0).forward, cx_list_at(v_, 1).forward, cx_list_at(v_, 2).forward, cx_list_at(v_, 3).forward, cx_list_at(v_, 0).height, cx_list_at(v_, 2).height, cx_list_at(v_, 0).right, cx_list_at(v_, 1).right }); };
}

fn post_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4621813488089437307))), @as(f64, @bitCast(@as(i64, 4621824747088505733))), @as(f64, @bitCast(@as(i64, 4621824747088505733))), @as(f64, @bitCast(@as(i64, 4621813488089437307))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4603129179135383962))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn diagonal() *CxList(RiderPt) {
    return cx_ll_of(RiderPt, &[_]RiderPt{ pt(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520)))), pt(@as(f64, @bitCast(@as(i64, 4629137466983448576))), @as(f64, @bitCast(@as(i64, 4632233691727265792)))) });
}

fn diag_got() *CxList(f64) {
    return b0: { const v_ = cx_list_at(posts(diagonal(), 0), 0).v_; break :b0 cx_ll_of(f64, &[_]f64{ cx_list_at(v_, 0).right, cx_list_at(v_, 1).right, cx_list_at(v_, 0).forward, cx_list_at(v_, 1).forward }); };
}

fn diag_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ (-@as(f64, @bitCast(@as(i64, 4573567551181324026)))), @as(f64, @bitCast(@as(i64, 4573567551181324026))), @as(f64, @bitCast(@as(i64, 4621814613989344150))), @as(f64, @bitCast(@as(i64, 4621823621188598890))) });
}

fn doubled() *CxList(RiderPt) {
    return cx_ll_of(RiderPt, &[_]RiderPt{ pt(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520)))), pt(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520)))) });
}

fn doubled_got() *CxList(f64) {
    return b0: { const v_ = cx_list_at(posts(doubled(), 0), 0).v_; break :b0 cx_ll_of(f64, &[_]f64{ cx_real_from_int(cx_list_len(rail_emit(doubled()))), cx_list_at(v_, 0).right, cx_list_at(v_, 1).right, cx_list_at(v_, 0).forward, cx_list_at(v_, 1).forward, cx_list_at(v_, 2).height }); };
}

fn doubled_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4613937818241073152))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4603129179135383962))) });
}

fn short_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ cx_list_len(rail_emit(cx_ll_empty(RiderPt))), cx_list_len(rail_emit(cx_ll_of(RiderPt, &[_]RiderPt{ pt(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520)))) }))), cx_list_len(rail_emit(doubled())), cx_list_len(bars(cx_ll_of(RiderPt, &[_]RiderPt{ pt(@as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520)))) }), 0)) });
}

fn short_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 0, 0, 3, 0 });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_reals("\x1d\x19\x49\x16\x11\x1a\x13\x02\x02", dims_got(), dims_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x1d\x19\x49\x1c\x11\x24\x0d\x16\x02", fixed_got(), fixed_want())); _ = cx_print_line(grade_ints("\x1d\x19\x49\x13\x14\x0f\x1f\x0d\x02", shape_got(), shape_want())); _ = cx_print_line(grade_ints("\x1d\x19\x49\x18\x10\x17\x10\x19\x15", colour_got(), colour_want())); _ = cx_print_line(grade_reals("\x1d\x19\x49\x1c\x1b\x16\x02\x02\x02", fwd_got(), fwd_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x1d\x19\x49\x20\x0f\x15\x02\x02\x02", bar_got(), bar_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x1d\x19\x49\x1f\x10\x13\x0e\x02\x02", post_got(), post_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x1d\x19\x49\x16\x11\x0f\x1d\x02\x02", diag_got(), diag_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x1d\x19\x49\x16\x10\x19\x20\x17\x0d", doubled_got(), doubled_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x1d\x19\x49\x13\x14\x10\x15\x0e\x02", short_got(), short_want())); break :b0; };
}

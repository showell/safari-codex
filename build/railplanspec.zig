...
fn steps_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ leg_steps(@as(f64, @bitCast(@as(i64, 0)))), leg_steps(@as(f64, @bitCast(@as(i64, 4600877379321698714)))), leg_steps(@as(f64, @bitCast(@as(i64, 4602678819172646912)))), leg_steps(@as(f64, @bitCast(@as(i64, 4607182418800017408)))), leg_steps(@as(f64, @bitCast(@as(i64, 4608983858650965606)))), leg_steps(@as(f64, @bitCast(@as(i64, 4609434218613702656)))), leg_steps(@as(f64, @bitCast(@as(i64, 4612811918334230528)))), leg_steps(@as(f64, @bitCast(@as(i64, 4621819117588971520)))), leg_steps(@as(f64, @bitCast(@as(i64, 4632177396731923661)))), leg_steps(@as(f64, @bitCast(@as(i64, 4632233691727265792)))) });
}

fn steps_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 1, 1, 1, 1, 1, 2, 3, 10, 50, 50 });
}

fn origin_pt() RiderPt {
    return cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 0))), .forward = @as(f64, @bitCast(@as(i64, 0))) });
}

fn straight() *CxList(RiderPt) {
    return push_leg(origin_pt(), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 0))), .forward = @as(f64, @bitCast(@as(i64, 4621819117588971520))) }));
}

fn straight_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ cx_real_from_int(cx_list_len(straight())), cx_list_at(straight(), 0).forward, cx_list_at(straight(), 4).forward, cx_list_at(straight(), 9).forward, cx_list_at(straight(), 0).right, cx_list_at(straight(), 9).right });
}

fn straight_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4617315517961601024))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 0))) });
}

fn diagonal() *CxList(RiderPt) {
    return push_leg(origin_pt(), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 4629137466983448576))), .forward = @as(f64, @bitCast(@as(i64, 4630826316843712512))) }));
}

fn diagonal_got() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ cx_real_from_int(cx_list_len(diagonal())), cx_list_at(diagonal(), 49).right, cx_list_at(diagonal(), 49).forward, cx_list_at(diagonal(), 24).right, cx_list_at(diagonal(), 24).forward });
}

fn diagonal_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4632233691727265792))), @as(f64, @bitCast(@as(i64, 4629137466983448576))), @as(f64, @bitCast(@as(i64, 4630826316843712512))), @as(f64, @bitCast(@as(i64, 4624633867356078080))), @as(f64, @bitCast(@as(i64, 4626322717216342016))) });
}

fn degenerate_got() *CxList(f64) {
    return b0: { const d_ = push_leg(cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 4613937818241073152))), .forward = @as(f64, @bitCast(@as(i64, 4616189618054758400))) }), cx_new(RiderPtS{ .right = @as(f64, @bitCast(@as(i64, 4613937818241073152))), .forward = @as(f64, @bitCast(@as(i64, 4616189618054758400))) })); break :b0 cx_ll_of(f64, &[_]f64{ cx_real_from_int(cx_list_len(d_)), cx_list_at(d_, 0).right, cx_list_at(d_, 0).forward }); };
}

fn degenerate_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4607182418800017408))), @as(f64, @bitCast(@as(i64, 4613937818241073152))), @as(f64, @bitCast(@as(i64, 4616189618054758400))) });
}

fn from_zero_got() *CxList(f64) {
    return b0: { const z_ = leg_points(origin_pt(), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520))), 10, 0); break :b0 cx_ll_of(f64, &[_]f64{ cx_real_from_int(cx_list_len(z_)), cx_list_at(z_, 0).forward, cx_list_at(z_, 10).forward }); };
}

fn from_zero_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4622382067542392832))), @as(f64, @bitCast(@as(i64, 0))), @as(f64, @bitCast(@as(i64, 4621819117588971520))) });
}
...
fn runout_got() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ rail_runout(), cx_list_len(rail_run_out(segs(), chain(), origin(), chain_map(0), @as(f64, @bitCast(@as(i64, 4616189618054758400))), 0)), cx_list_len(rail_run_up(segs(), chain(), origin(), chain_map(0), @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), rail_runout())) });
}

fn runout_want() *CxList(i64) {
    return cx_ll_of(i64, &[_]i64{ 10, 11, 11 });
}

fn runup_got() *CxList(f64) {
    return b0: { const u_ = rail_run_up(segs(), chain(), origin(), chain_map(0), @as(f64, @bitCast(@as(i64, 4647503709213818880))), @as(f64, @bitCast(@as(i64, 4616189618054758400))), rail_runout()); break :b0 cx_ll_of(f64, &[_]f64{ cx_list_at(u_, 0).forward, cx_list_at(u_, 10).forward }); };
}

fn runup_want() *CxList(f64) {
    return cx_ll_of(f64, &[_]f64{ @as(f64, @bitCast(@as(i64, 4647327787353374720))), @as(f64, @bitCast(@as(i64, 4647503709213818880))) });
}

fn opening() void {
    return b0: { _ = cx_print_line(grade_ints("\x15\x1f\x49\x13\x0e\x0d\x1f\x13\x02", steps_got(), steps_want())); _ = cx_print_line(grade_reals("\x15\x1f\x49\x13\x0e\x15\x0f\x11\x1d", straight_got(), straight_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x15\x1f\x49\x16\x11\x0f\x1d\x02\x02", diagonal_got(), diagonal_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x15\x1f\x49\x16\x0d\x1d\x0d\x12\x02", degenerate_got(), degenerate_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_reals("\x15\x1f\x49\x26\x0d\x15\x10\x02\x02", from_zero_got(), from_zero_want(), @as(f64, @bitCast(@as(i64, 0))))); _ = cx_print_line(grade_ints("\x15\x1f\x49\x15\x19\x12\x10\x19\x0e", runout_got(), runout_want())); _ = cx_print_line(grade_reals("\x15\x1f\x49\x15\x19\x12\x19\x1f\x02", runup_got(), runup_want(), @as(f64, @bitCast(@as(i64, 4547007122018943789))))); break :b0; };
}
